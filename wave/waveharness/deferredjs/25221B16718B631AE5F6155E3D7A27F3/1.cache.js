...
function $createRenderer(this$static){
  ...
  rules = new FullDomRenderer_0(!this$static.blipDetailer?(this$static.blipDetailer = new UndercurrentShallowBlipRenderer_0(!this$static.profileManager?(this$static.profileManager = new ProfileManagerImpl_0):this$static.profileManager, !this$static.supplement?(this$static.supplement = $createSupplement(this$static)):this$static.supplement)):this$static.blipDetailer, docRenderer, !this$static.profileManager?(this$static.profileManager = new ProfileManagerImpl_0):this$static.profileManager, !this$static.viewIdMapper?(this$static.viewIdMapper = new ViewIdMapper_0(new ModelIdMapperImpl_0(!this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations))):this$static.viewIdMapper, !this$static.threadReadStateMonitor?(this$static.threadReadStateMonitor = (monitor_0 = new ThreadReadStateMonitorImpl_0(!this$static.supplement?(this$static.supplement = $createSupplement(this$static)):this$static.supplement, !this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations) , $init_3(monitor_0) , monitor_0)):this$static.threadReadStateMonitor);
  return new HtmlDomRenderer_0(new ReductionBasedRenderer_0(rules, of_7(!this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations)));
}

function $install_1(this$static){
  var e;
  $install_4(!this$static.diffController?(this$static.diffController = new DiffController_0(!this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations, !this$static.supplement?(this$static.supplement = $createSupplement(this$static)):this$static.supplement, !this$static.documentRegistry?(this$static.documentRegistry = $createDocumentRegistry()):this$static.documentRegistry, !this$static.modelAsView?(this$static.modelAsView = new ModelAsViewProviderImpl_0(!this$static.viewIdMapper?(this$static.viewIdMapper = new ViewIdMapper_0(new ModelIdMapperImpl_0(!this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations))):this$static.viewIdMapper, this$static.stageOne.getDomAsViewProvider())):this$static.modelAsView)):this$static.diffController);
  ...
  e = $render_17(!this$static.renderer?(this$static.renderer = $createRenderer(this$static)):this$static.renderer, !this$static.conversations?(this$static.conversations = create_54(!this$static.wave?(this$static.wave = $createWave(this$static)):this$static.wave, !this$static.idGenerator?(this$static.idGenerator = $createIdGenerator(this$static)):this$static.idGenerator)):this$static.conversations);
  $init_5(this$static.stageOne.getWavePanel(), e);
...
_.use = function use_0(x){
  this.this$1.waveData = dynamicCast(x, 169);
...
_.use = function use_3(x){
  runAsync_0(new Stages$4_0(this.this$1.this$0, dynamicCast(x, 172)));
}
;
_.castableTypeMap$ = {177:1};
_.this$1 = null;
...
function $render_1(this$static){
  var c, conversations;
  conversations = ($clinit_2278() , defaultCollectionFactory.createIdentityMap());
...
function $fetchWave(this$static, whenReady){
  ...
  fake = create_28(!this$static.documentRegistry?(this$static.documentRegistry = $createDocumentRegistry()):this$static.documentRegistry);
...
function create_28(docFactory){
  ...
  sampleData = (sampleAuthor = ofUnsafe('nobody@example.com') , gen = new IdGeneratorImpl_0('example.com', new FakeIdGenerator$1_0) , waveData = new WaveViewDataImpl_0(of_8(gen.defaultDomain, $newId(gen, 'w'))) , docFactory_0 = ($clinit_2254() , new FakeDocument$Factory_0(schemas_0)) , waveletDataFactory = new UndercurrentHarness$WaveFactory$1_0(docFactory_0, waveData) , waveletFactory = $build_6($with_1($with_0(($clinit_2263() , new OpBasedWaveletFactory$Builder_0(schemas_0)), waveletDataFactory), sampleAuthor)) , wave = new WaveViewImpl_0(waveletFactory, waveData.id_0, gen, sampleAuthor, $clinit_2399()) , v = ($serialiseWaveId(wave.waveId) , convView = new WaveBasedConversationView_0(wave, gen) , $add_33(wave.listeners, convView) , convView) , c = (rootWavelet_0 = $createRoot_0(v.waveView) , $clinit_1692() , getOrCreateFirstTopLevelElement($getDocument_5(rootWavelet_0, 'conversation'), ($clinit_2064() , ABSENT)) , dynamicCast(v.conversations.get(rootWavelet_0), 367)) , root = c.rootThread , sampleReply((root.isUsable || illegalState('Deleted thread is not usable: ' + root) , $appendBlipWithContent(root))) , d = (root.isUsable || illegalState('Deleted thread is not usable: ' + root) , $appendBlipWithContent(root)).blip.blip.content_0.getMutableDocument() , d.emptyElement(dynamicCast(d.getDocumentElement(), 256)) , d.appendXml(innerXml($parse_1(($clinit_2081() , '<body><line><\/line>Hello World<\/body>')))) , d_0 = (root.isUsable || illegalState('Deleted thread is not usable: ' + root) , $appendBlipWithContent(root)).blip.blip.content_0.getMutableDocument() , d_0.emptyElement(dynamicCast(d_0.getDocumentElement(), 256)) , d_0.appendXml(innerXml($parse_1('<body><line><\/line>Hello World<\/body>'))) , d_1 = (root.isUsable || illegalState('Deleted thread is not usable: ' + root) , $appendBlipWithContent(root)).blip.blip.content_0.getMutableDocument() , d_1.emptyElement(dynamicCast(d_1.getDocumentElement(), 256)) , d_1.appendXml(innerXml($parse_1('<body><line><\/line>Hello World<\/body>'))) , waveData);
  newData = new WaveViewDataImpl_0(sampleData.id_0);
  copier = new WaveletDataImpl$Factory_0(docFactory);
  for (src$iterator = ($clinit_467() , new Collections$UnmodifiableCollection_0($values(sampleData.wavelets))).iterator_0(); src$iterator.hasNext();) {
    src = dynamicCast(src$iterator.next_0(), 168);
    ...
    for (p$iterator = (new Collections$UnmodifiableSet_0(src.participants)).iterator_0(); p$iterator.hasNext();) {
      p = dynamicCast(p$iterator.next_0(), 160);
...
function sampleReply(blip){
  ...
  d_1.emptyElement(dynamicCast(d_1.getDocumentElement(), 256));
  d_1.appendXml(innerXml($parse_1(($clinit_2081() , '<body><line><\/line>Hello World<\/body>'))));
  ...
  d_0.emptyElement(dynamicCast(d_0.getDocumentElement(), 256));
...
_.create_3 = function create_29(data){
  var wavelet;
...
_.asOperation = function asOperation_1(){
  return dynamicCast(this.document_0?this.document_0:this.spec, 257).asOperation();
}
;
...
function $stopReading(this$static, blip){
  ...
  dynamicCast(this$static.delegate, 259).markAsRead(this$static.reading);
...
function $install_4(this$static){
  ...
  $add_33(this$static.wave.listeners, this$static);
  for (conversation$iterator = ($clinit_467() , new Collections$UnmodifiableCollection_0($values(this$static.wave.conversations))).iterator_0(); conversation$iterator.hasNext();) {
    conversation = dynamicCast(conversation$iterator.next_0(), 251);
    $add_33(conversation.listeners, this$static);
  }
...
function $getNext_3(this$static, start){
  ...
  while (!!blipUi && !$isUnread(this$static.supplement, $blipOf_0(this$static.models.viewIdMapper, dynamicCast(blipUi.impl, 330).getId()))) {
...
function install_8(supplement, focus_0, models, documents){
  ...
  $add_33(focus_0.listeners, reader);
  return reader;
}
...
_.onFocusMoved = function onFocusMoved_0(oldUi, newUi){
  ...
  if (oldUi) {
    oldBlip = $blipOf_0(this.models.viewIdMapper, dynamicCast(oldUi.impl, 330).getId());
    document_0 = dynamicCast($get_18(this.documents, oldBlip), 271);
    if (oldBlip) {
      $stopReading(this.supplement, oldBlip);
      checkState_1(document_0.diffsRetained, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 66:1}, 0, [($clinit_415() , document_0.diffsSuppressed?TRUE_0:FALSE_0), document_0.diffsRetained?TRUE_0:FALSE_0]));
      document_0.diffsRetained = false;
      $clearDiffs(document_0);
    }
  }
  if (newUi) {
    newBlip = $blipOf_0(this.models.viewIdMapper, dynamicCast(newUi.impl, 330).getId());
    document_0 = dynamicCast($get_18(this.documents, newBlip), 271);
    if (newBlip) {
      checkState_1(!document_0.diffsRetained, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 66:1}, 0, [($clinit_415() , document_0.diffsSuppressed?TRUE_0:FALSE_0), document_0.diffsRetained?TRUE_0:FALSE_0]));
...
function $apply_21(soFar, key, item){
  return $apply_20(dynamicCast(soFar, 16), (dynamicCast(key, 245) , dynamicCast(item, 16)));
}
...
function $apply_26(this$static, wave){
  var conversation, conversation$iterator;
  for (conversation$iterator = ($clinit_467() , new Collections$UnmodifiableCollection_0($values(wave.conversations))).iterator_0(); conversation$iterator.hasNext();) {
    conversation = dynamicCast(conversation$iterator.next_0(), 245);
...
function addLazily(map, key, value){
  var list;
  list = dynamicCast(map.get(key), 359);
  if (!list) {
    list = ($clinit_2278() , defaultCollectionFactory.createQueue());
    map.put_0(key, list);
  }
  list.add_0(value);
}
...
function getMainConversation(view){
  ...
  root = $getRoot(view);
  if (!root) {
    for (curr$iterator = ($clinit_467() , new Collections$UnmodifiableCollection_0($values(view.conversations))).iterator_0(); curr$iterator.hasNext();) {
      curr = dynamicCast(curr$iterator.next_0(), 245);
...
function of_7(wave){
  ...
  for (conversation$iterator = ($clinit_467() , new Collections$UnmodifiableCollection_0($values(wave.conversations))).iterator_0(); conversation$iterator.hasNext();) {
    ...
    blip = anchor?dynamicCast(anchor.anchor.second, 243):null;
    blip?addLazily(anchoring = anchoring?anchoring:($clinit_2278() , defaultCollectionFactory.createIdentityMap()), blip, conversation):(unanchored = unanchored?unanchored:($clinit_2278() , defaultCollectionFactory.createQueue())).add_0(conversation);
  }
  !anchoring && (anchoring = ($clinit_2278() , $clinit_2278() , EMPTY_1));
...
function getOrCreateFirstTopLevelElement(doc, expectation){
  ...
  if (expectation == ($clinit_2064() , PRESENT) && firstNode == null) {
  ...
  if (firstNode == null) {
    return doc.createChildElement(doc.getDocumentElement(), 'conversation', ($clinit_1849() , EMPTY_MAP_0));
  }
   else {
...
function $clinit_2064(){
  $clinit_2064 = nullMethod;
  NONE_3 = new DocHelper$Expectation_0('NONE', 0);
  ABSENT = new DocHelper$Expectation_0('ABSENT', 1);
  PRESENT = new DocHelper$Expectation_0('PRESENT', 2);
  $VALUES_68 = initValues(_3Lorg_waveprotocol_wave_model_document_util_DocHelper$Expectation_2_classLit, {9:1, 66:1, 166:1}, 148, [NONE_3, ABSENT, PRESENT]);
}
...
function valueOf_75(name_0){
  $clinit_2064();
  return valueOf_0(($clinit_2065() , $MAP_68), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 63:1, 148:1};
var $VALUES_68, ABSENT, NONE_3, PRESENT;
function $clinit_2065(){
  $clinit_2065 = nullMethod;
  $MAP_68 = createValueOfMap(($clinit_2064() , $VALUES_68));
}
...
function $doInternalApply(this$static, wavelet){
  ...
  if (this$static.docId != null) {
    blip = dynamicCast(wavelet.documents.get(this$static.docId), 469);
...
_.equals$ = function equals_65(obj){
  var other;
  if (!(obj != null && obj.castableTypeMap$ && !!obj.castableTypeMap$[447])) {
    return false;
  }
  other = dynamicCast(obj, 447);
...
function $getSchemaForId(this$static, waveletId, documentId){
  ...
  for (provider$iterator = new Collections$UnmodifiableCollectionIterator_0(this$static.providers.coll.iterator_0()); provider$iterator.it.hasNext();) {
    provider = dynamicCast(provider$iterator.it.next_0(), 454);
    value = provider.getSchemaForId(waveletId, documentId);
    if (value != ($clinit_1978() , NO_SCHEMA_CONSTRAINTS)) {
      checkState_2(!result, 'Several different schemas apply to document');
      result = value;
    }
  }
  return !result?($clinit_1978() , NO_SCHEMA_CONSTRAINTS):result;
}
...
;
_.castableTypeMap$ = {454:1};
_.providers = null;
function $clinit_2254(){
  var emptyList;
  $clinit_2254 = nullMethod;
  schemas_0 = (emptyList = ($clinit_467() , $clinit_467() , EMPTY_LIST) , new SchemaCollection_0(emptyList?new Collections$UnmodifiableRandomAccessList_0(emptyList):new Collections$UnmodifiableList_0(null)));
}
...
;
_.castableTypeMap$ = {19:1, 262:1, 474:1};
...
_.create_1 = function create_66(waveletId, blipId, content_0){
  var result;
  return new FakeDocument_0(content_0, (result = $getSchemaForId(this.schemas, waveletId, blipId) , result?result:($clinit_1978() , NO_SCHEMA_CONSTRAINTS)));
}
;
...
function $clinit_2263(){
  $clinit_2263 = nullMethod;
...
_.create_0 = function create_67(waveId, waveletId, creator){
...
function $build_6(this$static){
  ...
  !this$static.sink && (this$static.sink = ($clinit_2164() , VOID));
  !this$static.author && (this$static.author = ($clinit_2263() , FAKE_PARTICIPANT));
...
_.consume = function consume_15(op){
  $consume_21(this, dynamicCast(op, 462));
}
;
...
_.getDocument_1 = function getDocument_3(documentId){
  return dynamicCast(this.documents.get(documentId), 469);
}
;
...
_.getParticipants = function getParticipants(){
  return $clinit_467() , new Collections$UnmodifiableSet_0(this.participants);
}
;
...
_.getDocumentIds = function getDocumentIds(){
  return $clinit_467() , $clinit_467() , EMPTY_SET;
}
;
...
function $addWavelet(this$static, wavelet){
  ...
  checkArgument_3(!this$static.wavelets.containsKey(waveletId), 'Duplicate wavelet id: %s', initValues(_3Ljava_lang_Object_2_classLit, {9:1, 66:1}, 0, [waveletId]));
  this$static.wavelets.put(waveletId, wavelet);
}

function WaveViewDataImpl_0(id){
  this.wavelets = ($clinit_2278() , new HashMap_0);
  this.id_0 = id;
}
...
_.getDocument_1 = function getDocument_5(documentName){
  return dynamicCast(this.documents.get(documentName), 469);
}
;
...
_.create_3 = function create_69(data){
