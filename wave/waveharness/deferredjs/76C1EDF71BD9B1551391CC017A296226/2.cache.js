...
function updateAnimations(){
  ...
  curAnimations = initDim(_3Lcom_google_gwt_animation_client_Animation_2_classLit, {3:1, 9:1, 68:1}, 69, animations.size_0, 0);
...
function $layout(this$static, duration, callback){
  ...
  if (duration == 0) {
    for (l$iterator = new AbstractList$IteratorImpl_0(this$static.layers); l$iterator.i < l$iterator.this$0_0.size_1();) {
      l_0 = dynamicCast($next_4(l$iterator), 51);
...
function $onUpdate(this$static, progress){
  ...
  for (l$iterator = new AbstractList$IteratorImpl_0(this$static.this$0.layers); l$iterator.i < l$iterator.this$0_0.size_1();) {
    ...
    $layout_0(l_0);
    !!this$static.val$callback && (child = l_0.userObject , child != null && child.castableTypeMap$ && !!child.castableTypeMap$[56] && dynamicCast(child, 56).onResize() , undefined);
  }
}
...
function $clinit_255(){
  ...
  $VALUES_7 = initValues(_3Lcom_google_gwt_layout_client_Layout$Alignment_2_classLit, {9:1, 68:1, 170:1}, 80, [BEGIN, END, STRETCH]);
}
...
function valueOf_9(name_0){
  $clinit_255();
  return valueOf_0(($clinit_256() , $MAP_7), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 80:1};
var $VALUES_7, BEGIN, END, STRETCH;
function $clinit_256(){
  $clinit_256 = nullMethod;
  $MAP_7 = createValueOfMap(($clinit_255() , $VALUES_7));
}
...
function $clinit_312(){
  ...
  impl_1 = ($clinit_414() , $clinit_414() , implWidget);
}
...
function Button_2(html, handler){
  ...
  Button_0.call(this);
  this.element.innerHTML = html || '';
  $addDomHandler(this, handler, ($clinit_116() , $clinit_116() , TYPE_1));
}
...
function $addValueChangeHandler_0(this$static, handler){
  ...
  return $addHandler_1(this$static, handler, (!TYPE_12 && (TYPE_12 = new GwtEvent$Type_0) , TYPE_12));
}

function $getValue_1(this$static){
  return this$static.attached?($clinit_428() , this$static.inputElem.checked?TRUE_0:FALSE_0):($clinit_428() , this$static.inputElem.defaultChecked?TRUE_0:FALSE_0);
}

function $setValue_1(this$static, value){
  var oldValue;
  !value && (value = ($clinit_428() , FALSE_0));
  oldValue = this$static.attached?($clinit_428() , this$static.inputElem.checked?TRUE_0:FALSE_0):($clinit_428() , this$static.inputElem.defaultChecked?TRUE_0:FALSE_0);
...
_.ensureDomEventHandlers = function ensureDomEventHandlers(){
  $addDomHandler(this, new CheckBox$1_0(this), ($clinit_116() , $clinit_116() , TYPE_1));
}
;
...
_.onUnload = function onUnload_0(){
  ...
  $setValue_1(this, this.attached?($clinit_428() , this.inputElem.checked?TRUE_0:FALSE_0):($clinit_428() , this.inputElem.defaultChecked?TRUE_0:FALSE_0));
}
;
...
_.onClick = function onClick(event_0){
  fire_2(this.this$0, $getValue_1(this.this$0));
}
;
...
function $doLayout(this$static){
  ...
  for (child$iterator = new WidgetCollection$WidgetIterator_0(this$static.children_0); child$iterator.index_0 < child$iterator.this$0.size_0 - 1;) {
    ...
    layer = data.layer;
    switch ($getResolvedDirection(data.direction_0).ordinal) {
      case 0:
...
function $getResolvedDirection(direction){
  if (direction == ($clinit_322() , LINE_START)) {
    return $clinit_211() , WEST;
  }
   else if (direction == LINE_END) {
    return $clinit_211() , EAST;
  }
  return direction;
}
...
function $insert_0(this$static, widget, direction, size){
  ...
  direction == ($clinit_322() , CENTER) && (this$static.center = widget);
...
_.onResize = function onResize_0(){
  ...
  for (child$iterator = new WidgetCollection$WidgetIterator_0(this.children_0); child$iterator.index_0 < child$iterator.this$0.size_0 - 1;) {
    child = $next_1(child$iterator);
    child != null && child.castableTypeMap$ && !!child.castableTypeMap$[56] && dynamicCast(child, 56).onResize();
  }
}
;
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 56:1, 59:1, 61:1};
_.center = null;
_.layout = null;
_.layoutCmd = null;
_.unit = null;
function $clinit_322(){
  ...
  $VALUES_8 = initValues(_3Lcom_google_gwt_user_client_ui_DockLayoutPanel$Direction_2_classLit, {9:1, 68:1, 170:1}, 81, [NORTH, EAST, SOUTH, WEST, CENTER, LINE_START, LINE_END]);
}
...
function valueOf_10(name_0){
  $clinit_322();
  return valueOf_0(($clinit_323() , $MAP_8), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 81:1};
var $VALUES_8, CENTER, EAST, LINE_END, LINE_START, NORTH, SOUTH, WEST;
function $clinit_323(){
  $clinit_323 = nullMethod;
  $MAP_8 = createValueOfMap(($clinit_322() , $VALUES_8));
}
...
_.dispatch = function dispatch_15(handler){
  $onSubmitComplete(dynamicCast(handler, 57), this);
}
;
...
function HorizontalPanel_0(){
  ...
  this.horzAlign = ($clinit_353() , ALIGN_DEFAULT);
  this.vertAlign = ($clinit_360() , ALIGN_TOP);
...
_.onBrowserEvent = function onBrowserEvent_4(event_0){
  ...
  switch ($eventGetTypeInt(event_0.type)) {
    ...
    case 4096:
    case 128:
      this.oldValue = this.attached?($clinit_428() , this.inputElem.checked?TRUE_0:FALSE_0):($clinit_428() , this.inputElem.defaultChecked?TRUE_0:FALSE_0);
      break;
    case 1:
      ...
      $onBrowserEvent(this, event_0);
      fireIfNotEqual(this, this.oldValue, this.attached?($clinit_428() , this.inputElem.checked?TRUE_0:FALSE_0):($clinit_428() , this.inputElem.defaultChecked?TRUE_0:FALSE_0));
      return;
  }
  $onBrowserEvent(this, event_0);
}
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 59:1, 232:1};
_.oldValue = null;
...
_.onResize = function onResize_1(){
  var child;
  child = this.widget;
  !!child && child != null && child.castableTypeMap$ && !!child.castableTypeMap$[56] && dynamicCast(child, 56).onResize();
}
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 56:1, 59:1, 61:1};
...
function $clinit_403(){
  ...
  $VALUES_9 = initValues(_3Lcom_google_gwt_user_client_ui_ValueBoxBase$TextAlignment_2_classLit, {9:1, 68:1, 170:1}, 82, [CENTER_0, JUSTIFY, LEFT, RIGHT]);
}

function valueOf_11(name_0){
  $clinit_403();
  return valueOf_0(($clinit_408() , $MAP_9), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 82:1};
var $VALUES_9, CENTER_0, JUSTIFY, LEFT, RIGHT;
...
function $clinit_408(){
  ...
  $MAP_9 = createValueOfMap(($clinit_403() , $VALUES_9));
}
...
function copyOf(c){
  ...
  first = dynamicCast((entry = dynamicCast(it.val$outerIter.next_0(), 11) , entry.getKey()), 65);
  clazz = $getDeclaringClass(first);
  set = noneOf(clazz);
  $add_11(set, first);
  while (it.val$outerIter.hasNext()) {
    $add_11(set, dynamicCast((entry_0 = dynamicCast(it.val$outerIter.next_0(), 11) , entry_0.getKey()), 65));
  }
  return set;
}
...
function $createEditSession(this$static){
  ...
  return $clinit_1310() , edit = new EditSession_0(views, documents, panel.panel, selectionExtractor) , $add_31(focus_0.listeners, edit) , !!panel.main && undefined , $add_31(panel.listeners, focus_0) , $clinit_769() , e_0 = $doc.createElement('div') , e_0.className = 'editor' , new EditorImpl_0(true, e_0) , edit;
}
...
_.create = function create_7(whenReady){
  ...
  this.onStageInit();
  get_22().enableUndercurrentEditing.value_0 && ($clinit_761() , !provider_1 && (provider_1 = new DesktopPopupProvider_0) , $clinit_761() , popupChromeProvider = (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , provider_0) , panel = this.stageTwo.stageOne.getWavePanel() , focus_0 = this.stageTwo.stageOne.getFocusFrame() , $getSignedInUser(this.stageTwo) , models = $getModelAsViewProvider(this.stageTwo) , profiles = $getProfileManager(this.stageTwo) , actions = !this.actions?(this.actions = (stageOne = this.stageTwo.stageOne , stageOne.getWavePanel() , focus_1 = stageOne.getFocusFrame() , views = $getModelAsViewProvider(this.stageTwo) , docs = $getDocumentRegistry(this.stageTwo) , blipQueue = $getBlipQueue(this.stageTwo) , edit_0 = !this.edit?(this.edit = $createEditSession(this)):this.edit , new ActionsImpl_0(views, docs, blipQueue, focus_1, edit_0))):this.actions , edit = !this.edit?(this.edit = $createEditSession(this)):this.edit , controller = new MenuController_0(actions, panel.views) , $register_0(panel.panel.clickHandlers, ($clinit_1531() , dynamicCast($get_10(CODES, ($clinit_1453() , MENU_ITEM)), 1)), controller) , switcher = new ToolbarSwitcher_0(this.stageTwo.stageOne.getWavePanel(), !this.edit?(this.edit = $createEditSession(this)):this.edit, !this.viewToolbar?(this.viewToolbar = (views_0 = $getModelAsViewProvider(this.stageTwo) , wave = $getConversations(this.stageTwo) , create_38(this.stageTwo.stageOne.getFocusFrame(), views_0, wave, this.stageTwo.reader))):this.viewToolbar, !this.editToolbar?(this.editToolbar = create_37($getSignedInUser(this.stageTwo), $getIdGenerator(this.stageTwo), $getWave(this.stageTwo).waveId)):this.editToolbar) , $init_10(switcher.viewToolbar) , $init_8(switcher.editToolbar) , $add_31(switcher.editSession.listeners, switcher) , switcher.editSession.editing?$startEditSession(switcher, switcher.editSession.editor):!!switcher.panel.main && ($setToolbar_1($getContents_0(switcher.panel), switcher.viewToolbar.toolbarUi.element) , $doAdopt(switcher.panel.panel, switcher.viewToolbar.toolbarUi)) , new WaveTitleHandler_0(edit, models) , controller_0 = new ReplyIndicatorController_0(actions, edit, panel.views) , $register_0(panel.panel.mouseDownHandlers, dynamicCast($get_10(CODES, REPLY_BOX), 1), controller_0) , $register_0(panel.panel.mouseDownHandlers, dynamicCast($get_10(CODES, CONTINUATION_INDICATOR), 1), controller_0) , $clinit_1309() , $install_5(new EditController_0(new FocusedActions_0(focus_0, actions), DEFAULT_BINDINGS), panel.keys) , controller_1 = new ParticipantController_0(panel.views, models, profiles) , $install_6(controller_1, panel.panel) , $init_7(new KeepFocusInView_0(edit, panel)) , $upgrade($getDiffController(this.stageTwo), edit) , undefined);
  this.onStageLoaded();
  $use(whenReady, this);
}
;
...
function serializeAnnotation(rangedAnnotations){
  ...
  for (ann$iterator = new AbstractList$IteratorImpl_0(rangedAnnotations); ann$iterator.i < ann$iterator.this$0_0.size_1();) {
    ann = dynamicCast($next_4(ann$iterator), 181);
...
function $fillBufferAndSetSelection(this$static, htmlFragment, selection, waveXml, normalizedAnnotation){
  ...
  !!waveXml && !!normalizedAnnotation && (selection = $hijackFragment(waveXml.builder.impl.string, serializeAnnotation(normalizedAnnotation), selection));
  $clinit_1046();
  cache_1 = null;
  $set_8(selection.first, selection.second);
}
...
function $getPasteContainer(this$static){
  $stripMarkers(this$static);
  return this$static.element;
}

function $maybeStripMarker(this$static, node, parent_0, leading){
  var text, textNode;
  if (!node) {
    $log_0(($clinit_589() , LOG).errorLogger, 'end not found: node is null');
    return;
  }
  if (node.nodeType == 3) {
    textNode = node;
    text = textNode.data;
    !text.length?$log_0(($clinit_589() , LOG).errorLogger, 'end not found: text node is empty'):leading?text.charCodeAt(0) == 127 && (textNode.data = text.substr(1, text.length - 1) , undefined):text.charCodeAt(text.length - 1) == 127?(textNode.data = text.substr(0, text.length - 1 - 0) , undefined):$log_0(($clinit_589() , LOG).errorLogger, 'end not found: last character is not marker');
    !textNode.data.length && parent_0.removeChild(textNode);
  }
   else {
    $maybeStripMarker(this$static, leading?node.firstChild:node.lastChild, node, leading);
  }
}

function $prepareForPaste(this$static){
  this$static.element.innerHTML = '';
  this$static.element.appendChild($doc.createTextNode('\x7F\x7F'));
  setCaret(new Point$Tx_0(this$static.element.firstChild, 1));
  this$static.markersStripped = false;
}

function $stripMarkers(this$static){
  if (this$static.markersStripped) {
    return;
  }
  $maybeStripMarker(this$static, this$static.element.firstChild, this$static.element, true);
  $maybeStripMarker(this$static, this$static.element.lastChild, this$static.element, false);
  this$static.markersStripped = true;
}
...
function focus_16(element){
  var $e0;
  try {
    ($clinit_414() , $clinit_414() , implWidget).focus_1(element);
  }
   catch ($e0) {
    $e0 = caught_0($e0);
...
function getContentEditability(element){
  var $e0, $e1, e, editability, elementString, elementTag, sb, style;
  style = element.style;
  editability = style['-webkit-user-modify'];
  if ($equalsIgnoreCase('read-write-plaintext-only', editability) || $equalsIgnoreCase('read-write', editability)) {
    return $clinit_603() , EDITABLE;
  }
   else if (editability != null && !!editability.length) {
    return $clinit_603() , NOT_EDITABLE;
  }
  try {
  ...
  return editability == null || !editability.length?($clinit_603() , NEUTRAL):$equalsIgnoreCase('true', editability)?($clinit_603() , EDITABLE):($clinit_603() , NOT_EDITABLE);
}
...
function getElementsByClassName(e){
  var all, i, item, ret;
  if ($clinit_649() , SUPPORTS_GET_ELEMENTS_BY_CLASSNAME) {
...
function isEditable_0(e){
  ...
  do {
    ...
    if (editability == ($clinit_603() , NEUTRAL)) {
      if (e == docElement) {
        return false;
      }
...
function $clinit_603(){
  ...
  $VALUES_12 = initValues(_3Lorg_waveprotocol_wave_client_common_util_DomHelper$ElementEditability_2_classLit, {9:1, 68:1, 170:1}, 88, [EDITABLE, NOT_EDITABLE, NEUTRAL]);
}
...
function valueOf_19(name_0){
  $clinit_603();
  return valueOf_0(($clinit_604() , $MAP_12), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 88:1};
var $VALUES_12, EDITABLE, NEUTRAL, NOT_EDITABLE;
function $clinit_604(){
  $clinit_604 = nullMethod;
  $MAP_12 = createValueOfMap(($clinit_603() , $VALUES_12));
}
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 59:1, 61:1, 236:1};
function OffsetPosition_0(left, top_0, offsetParent){
  this.left_0 = left;
  this.top_0 = top_0;
  this.offsetParent_0 = offsetParent;
}

function OffsetPosition(){
}

_ = OffsetPosition_0.prototype = OffsetPosition.prototype = new Object_0;
_.getClass$ = function getClass_389(){
  return Lorg_waveprotocol_wave_client_common_util_OffsetPosition_2_classLit;
}
;
_.castableTypeMap$ = {};
_.left_0 = 0;
_.offsetParent_0 = null;
_.top_0 = 0;
function $clinit_655(){
  $clinit_655 = nullMethod;
  ...
  $VALUES_14 = initValues(_3Lorg_waveprotocol_wave_client_common_util_SignalEvent$KeyModifier_2_classLit, {9:1, 68:1, 170:1}, 90, [NONE_0, SHIFT, CTRL, ALT, META, COMMAND, CTRL_ALT, COMMAND_SHIFT]);
  COMMAND_IS_CTRL = !($clinit_682() , $clinit_682() , INSTANCE_4).isMac;
}

function valueOf_21(name_0){
  $clinit_655();
  return valueOf_0(($clinit_664() , $MAP_14), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 90:1};
var $VALUES_14, ALT, COMMAND, COMMAND_IS_CTRL, COMMAND_SHIFT, CTRL, CTRL_ALT, META, NONE_0, SHIFT;
...
_.check = function check_7(event_0){
  ...
  return !!event_0.nativeEvent.shiftKey && !event_0.nativeEvent.altKey && (($clinit_669() , logic_0).commandIsCtrl?!!event_0.nativeEvent.ctrlKey:!!event_0.nativeEvent.metaKey) && !notCommandKey;
}
;
...
_.castableTypeMap$ = {9:1, 10:1, 65:1, 90:1};
function $clinit_664(){
  $clinit_664 = nullMethod;
  $MAP_14 = createValueOfMap(($clinit_655() , $VALUES_14));
}

var $MAP_14;
function $clinit_667(){
  $clinit_667 = nullMethod;
  ...
  $VALUES_16 = initValues(_3Lorg_waveprotocol_wave_client_common_util_SignalEvent$MoveUnit_2_classLit, {9:1, 68:1, 170:1}, 92, [CHARACTER, WORD, LINE, PAGE, DOCUMENT]);
}
...
function valueOf_23(name_0){
  $clinit_667();
  return valueOf_0(($clinit_668() , $MAP_16), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 92:1};
var $VALUES_16, CHARACTER, DOCUMENT, LINE, PAGE, WORD;
function $clinit_668(){
  $clinit_668 = nullMethod;
  $MAP_16 = createValueOfMap(($clinit_667() , $VALUES_16));
}
...
function $isRedoCombo(this$static){
  if ((($clinit_682() , $clinit_682() , INSTANCE_4).isMac || INSTANCE_4.isLinux) && $isCombo(this$static, 90, ($clinit_655() , COMMAND_SHIFT))) {
    return true;
  }
  return !INSTANCE_4.isMac && $isCombo(this$static, 89, ($clinit_655() , COMMAND));
}

function addDebugClass(uiObject){
  checkNotNull_0(uiObject, 'uiObject cannot be null');
  checkNotNull_0(uiObject.element, 'addDebugClass: Element must not be null');
}
...
_.getBias = function getBias_0(left, right, cursor){
  var ret;
  ret = new Box_1(($clinit_1780() , NEITHER));
  ($clinit_707() , KEYS).each_3(new LinkAnnotationHandler$2$1_0(left, ret, right));
  return dynamicCast(ret.boxed, 137);
}
;
...
_.apply_4 = function apply_18(key){
  this.val$left.get_4(key) != null?(this.val$ret.boxed = ($clinit_1780() , RIGHT_4)):this.val$right.get_4(key) != null && (this.val$ret.boxed = ($clinit_1780() , LEFT_4));
}
;
...
function $start(this$static, context){
  ...
  $add_31(context.updateEvent.updateListeners, this$static);
}
...
function $stop(this$static, context){
  ...
  rangeKey = ($clinit_717() , 'user/r/' + this$static.sessionId);
...
function $writeSelection(this$static, context){
  ...
  compositionState = $getContent(context.imeExtractor);
...
function $getSelectionHelper(this$static){
  if (!this$static.editor) {
    $log_0(($clinit_761() , logger_1).errorLogger, "Don't access editor selection with context not attached to an editor!");
    return $clinit_1040() , NOP_IMPL_0;
  }
...
function $blur_0(this$static){
  if (this$static.content_0) {
    !!this$static.content_0 && $flush_1(this$static.typing);
    if (get_21()) {
      ($clinit_414() , $clinit_414() , implWidget).blur_0(dynamicCast(this$static.content_0.fullContentView.inner_0.getDocumentElement(), 196).implNodelet);
      $clinit_1046();
      cache_1 = null;
...
function $debugConnectOpSinks(this$static, isConnected){
  ...
  if (this$static.permitOperations) {
    for (op$iterator = new AbstractList$IteratorImpl_0(this$static.suppressedOutgoingOps); op$iterator.i < op$iterator.this$0_0.size_1();) {
      op = dynamicCast($next_4(op$iterator), 207);
      $consume_1(this$static.outgoingOperationSink, op);
    }
    this$static.suppressedOutgoingOps = null;
    $clinit_1197();
    $schedule_2(scheduler_0, ($clinit_1200() , LOW), this$static.consistencyQueue);
  }
   else {
...
function $fireKeyboardEvent(this$static, evt){
  ...
  if (this$static.keySignalListeners) {
    for (l$iterator = (outerIter = $keySet_0(this$static.keySignalListeners.map).val$entrySet.iterator_0() , new AbstractMap$1$1_0(outerIter)); l$iterator.val$outerIter.hasNext();) {
      l_0 = dynamicCast((entry = dynamicCast(l$iterator.val$outerIter.next_0(), 11) , entry.getKey()), 204);
...
function $focus_1(this$static, collapsed){
  var docElement, htmlSelection;
  if (!this$static.attached) {
    $log_0(($clinit_761() , logger_1).errorLogger, "Shouldn't focus a detached editor");
    return;
  }
  if (this$static.editing && !!this$static.content_0) {
    htmlSelection = this$static.content_0?$getHtmlSelection_0(this$static.htmlSelectionHelper):null;
    docElement = dynamicCast(this$static.content_0.fullContentView.inner_0.getDocumentElement(), 196).implNodelet;
    $maybeSaveAncestorScrollPositions(this$static, docElement);
    ($clinit_414() , $clinit_414() , implWidget).focus_1(docElement);
    $maybeRestoreAncestorScrollPositions(this$static);
    if (htmlSelection) {
      $clinit_1046();
      cache_1 = null;
      $set_8(htmlSelection.anchor, htmlSelection.focus_0);
      if (collapsed) {
        $log_0(($clinit_761() , logger_1).traceLogger, 'Saving...');
        $doSaveSelection(this$static);
      }
       else {
        return;
      }
    }
    $safelyRestoreSelection(this$static, this$static.aggressiveSelectionHelper, collapsed);
    $scheduleUpdateNotification_0(this$static.updateEvent, true, true, false, false);
  }
}
...
function $init_2(this$static, bindings, settings){
  ...
  this$static.eventHandler = new EditorEventHandler_0(new EditorImpl$EditorInteractorImpl_0(this$static), this$static.eventsSubHandler, ($clinit_877() , INSTANCE_7), settings.useWhitelistInEditor, settings.useWebkitCompositionEvents);
  $setEditing(this$static, false);
}

function $insertText(this$static, at, text, isReplace){
  var builder, location_0;
  text = $coerceString(($clinit_2011() , text));
  ...
  isReplace || $supplementAnnotations(this$static.annotationLogic, location_0, this$static.currentSelectionBias, ($clinit_1782() , PLAIN_TEXT));
...
function $maybeSaveAncestorScrollPositions(this$static, e){
  $clinit_649();
  this$static.ancestorScrollTops = ($clinit_2309() , defaultCollectionFactory.createIdentityMap());
  while (e) {
    this$static.ancestorScrollTops.put_0(e, valueOf_13(e.scrollTop || 0));
    e = $getParentElement(e);
  }
}
...
function $rebiasSelection(this$static, lastDirection){
  if (!!this$static.typing && ($isBusy(this$static.typing) || this$static.domMutationReverter.entries.size_0 != 0)) {
    this$static.currentSelectionBias = ($clinit_1780() , LEFT_4);
    return;
  }
  !instance_7 && (instance_7 = new BrowserBackedScheduler_0 , setDefaultTimerService() , undefined);
...
function $removeContent(this$static){
  ...
  if (this$static.ownsDocument) {
    $setRendering(oldDoc);
    $replaceOutgoingSink(oldDoc, ($clinit_2195() , VOID));
  }
   else {
    checkState_2(!!oldDoc.logicalPanel, "Don't have a logicalPanel");
    $adjustLevel(oldDoc, ($clinit_835() , INTERACTIVE));
  }
  return oldDoc;
}
...
function $safelyRestoreSelection(this$static, selectionHelper, collapsed){
  ...
  if (sel) {
    $log_0(($clinit_761() , logger_1).traceLogger, 'Focusing, set selection at: ' + sel.focus_0);
  ...
  if (!selectionRestored) {
    $log_0(($clinit_761() , logger_1).traceLogger, 'Focusing at last valid point as a catch-all');
...
function $shouldTrackCursor(event_0){
  ...
  if (($clinit_669() , MOUSE_BUTTON_EVENTS).contains_0(event_0.nativeEvent.type)) {
    return true;
  }
  if (KEY_EVENTS.contains_0(event_0.nativeEvent.type)) {
    keySignalType = event_0.keySignalType;
    keyCode = event_0.cachedKeyCode;
    return keySignalType == ($clinit_665() , INPUT) || keySignalType == DELETE_0 || keySignalType == NAVIGATION && keyCode != 34 && keyCode != 33;
  }
  return false;
}
...
function $undoableSequence_0(this$static, cmd){
  ...
  $push_2(this$static.responsibility.sequenceType, ($clinit_784() , DIRECT));
  try {
    cmd.run();
  }
   finally {
...
function EditorImpl_0(ownsDocument, div){
  $clinit_735();
  this.children_0 = new WidgetCollection_0(this);
  this.editorPackage = new EditorImpl$1_0(this);
  this.elementsWithDisplayEditModes = ($clinit_2326() , $clinit_2326() , new CopyOnWriteSet_0(HASH_SET));
  this.settings = ($clinit_759() , DEFAULT_0);
  ...
  this.currentSelectionBias = ($clinit_1780() , LEFT_4);
  this.keyBindings = ($clinit_1035() , NONE_1);
  ...
  this.domHandlers = ($clinit_2309() , defaultCollectionFactory.createIdentitySet());
...
_ = EditorImpl_0.prototype = EditorImpl.prototype = new LogicalPanel$Impl;
...
_.onJavaScriptEvent = function onJavaScriptEvent(name_0, rawEvent){
  ...
  try {
    event_0 = dynamicCast(create_16(($clinit_982() , FACTORY), rawEvent, !hackEditorNeverConsumes), 200);
    try {
      if (($clinit_682() , $clinit_682() , INSTANCE_4).isMac && !!rawEvent.ctrlKey && !!rawEvent.altKey && $eventGetTypeInt(rawEvent.type) == 256) {
        $log_0(($clinit_761() , logger_1).traceLogger, 'Cancelling dangerous: ' + rawEvent.type);
    ...
    if (!isMutationEvent || ($clinit_761() , ignoreMutations <= 0)) {
      $clinit_761();
      ++ignoreMutations;
      try {
    ...
    if (instanceOf($e0, 201)) {
      e = $e0;
      $log_0(($clinit_761() , logger_1).errorLogger, 'Operation Exception - probably an invalid operation -> All bets are off!!! Not even going to try to repair!!');
      null.nullMethod();
      dynamicCast(this.content_0.fullContentView.inner_0.getDocumentElement(), 196);
      rawEvent.preventDefault();
      throw e;
    }
     else if (instanceOf($e0, 202)) {
      e = $e0;
      try {
        $logPlainText(($clinit_761() , logger_1).errorLogger, 'Invalid local operation swallowed ' + e);
      }
       catch ($e1) {
        $e1 = caught_0($e1);
        if (instanceOf($e1, 203)) {
          throw e;
        }
         else 
          throw $e1;
      ...
      e = $e0;
      try {
        $log_0(($clinit_761() , logger_1).errorLogger, 'Repairing: ' + e);
        el = is_0(rawEvent.target)?$findElementWrapper_0(this.nodeManager, rawEvent.target):null;
        if (!el) {
          $clinit_756();
          savedDoc = $removeContent(this);
          oldLevel = $adjustLevel(savedDoc, ($clinit_835() , SHELVED));
          $setupBehaviour(savedDoc, savedDoc.fullRawSubstrate.rootElement, oldLevel);
          $setContent_1(this, savedDoc);
          $log_0(logger_1.errorLogger, 'repairing region: ' + dynamicCast(this.content_0.fullContentView.inner_0.getDocumentElement(), 196));
        }
         else {
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 59:1, 61:1, 236:1, 240:1};
...
_.execute_0 = function execute_16(){
  ...
  this.this$0.settings.useFancyCursorBias || (current = ($clinit_1784() , FROM_LEFT));
  ...
  if (focused) {
    ...
    this.this$0.currentSelectionBias = ($clinit_1780() , LEFT_4);
  }
}
;
...
function $getLastValidSelectionPoint(this$static){
  var point;
  point = $findOrCreateValidSelectionPoint(this$static, new Point$El_0(dynamicCast(this$static.renderedContentView.inner_0.getDocumentElement(), 197), null));
  if (!point) {
...
function $setCaret_0(this$static, caret){
  ...
  !!nodeletCaret && ($clinit_1046() , $clinit_1046() , cache_1 = null , $clinit_1046() , $clinit_1046() , cache_1 = null , $set_8(nodeletCaret, nodeletCaret));
  $saveSelection(this$static);
}

_ = PassiveSelectionHelper.prototype;
_.getOrderedSelectionRange = function getOrderedSelectionRange(){
  var selection_0;
  return selection_0 = $getSelectionRange(this) , selection_0?(!selection_0.range && (selection_0.range = selection_0.anchor < selection_0.focus_0?new Range_2(selection_0.anchor, selection_0.focus_0):new Range_2(selection_0.focus_0, selection_0.anchor)) , selection_0.range):null;
}
;
...
function $scheduleRevert(this$static){
  if (!$isTyping(this$static.this$0)) {
    $log_0(($clinit_761() , logger_1).traceLogger, 'WARNING: Dom removal outside of known typing context');
    $clinit_1197();
    $schedule_2(scheduler_0, ($clinit_1200() , LOW), this$static.val$revertTask);
  }
}
...
_.apply_3 = function apply_24(e, i){
  dynamicCastJso(e).scrollTop = dynamicCast(i, 66).value_0;
}
;
...
function $consume_1(this$static, op){
  ...
  try {
    ...
    if (instanceOf($e0, 183)) {
      e = $e0;
      !this$static.this$0.innerOutputSink?$logPlainText_0(($clinit_761() , logger_1).fatalLogger, 'Output sink is null', new ClientDebugException_0(e)):$logPlainText_0(($clinit_761() , logger_1).fatalLogger, 'Output sink threw exception', e);
    }
     else 
      throw $e0;
  }
...
_.consume = function consume_2(op){
  $consume_1(this, dynamicCast(op, 207));
}
;
...
function $getAnnotation_0(this$static, key){
  ...
  if (!browserSelection) {
    $log_0(($clinit_761() , logger_1).errorLogger, 'No selection when resolving editor annotations.');
    return null;
  }
   else if (browserSelection.anchor != browserSelection.focus_0) {
    $log_0(($clinit_761() , logger_1).errorLogger, 'Resolving selection annotations is only supported while the browser selection is collapsed');
    return null;
  }
  at = browserSelection.focus_0;
  biasLeft = this$static.this$0.currentSelectionBias != ($clinit_1780() , RIGHT_4);
...
_.castableTypeMap$ = {};
_.this$0 = null;
_ = EditorImpl$7.prototype;
_.endTransientMutations = function endTransientMutations(){
  $clinit_761();
  --ignoreMutations;
}
;
_.startTransientMutations = function startTransientMutations(){
  $clinit_761();
  ++ignoreMutations;
}
;
...
function $execute_0(this$static){
  ...
  this$static.commands = ($clinit_2309() , defaultCollectionFactory.createQueue());
  while ($isConsistent(this$static.this$0) && !backup.isEmpty()) {
    dynamicCast(backup.poll(), 208).run();
  }
  backup.addAll(this$static.commands);
  this$static.commands = backup;
  this$static.commands.isEmpty() || this$static.this$0.permitOperations && ($clinit_1197() , $schedule_2(scheduler_0, ($clinit_1200() , LOW), this$static));
}

function EditorImpl$ConsistentStateCommandRunner_0(this$0){
  this.this$0 = this$0;
  this.commands = ($clinit_2309() , defaultCollectionFactory.createQueue());
}
  ...
  if ($check_1(($clinit_655() , event_0))) {
    ...
    if (num >= 1 && num <= 6) {
      if (num == 5) {
        ...
        toggle(this$static.this$0.content_0.indexedDoc, startLoc, endLoc, ($clinit_925() , checkArgument_2(!$equals_3('li', type), "Don't use regularStyle() for list styles, use listStyle()") , new Paragraph$RegularStyler_0(type)));
      }
      $clinit_756();
      return true;
    }
      ...
      $clinit_925();
      traverse(this$static.this$0.content_0.indexedDoc, startLoc, endLoc, new Paragraph$3_0(($clinit_930() , LEFT_1), true));
      traverse(this$static.this$0.content_0.indexedDoc, startLoc, endLoc, new Paragraph$3_0(($clinit_932() , LTR_0), true));
      $clinit_756();
      return true;
    }
     else if (num == 8) {
      $clinit_925();
      traverse(this$static.this$0.content_0.indexedDoc, startLoc, endLoc, new Paragraph$3_0(($clinit_930() , RIGHT_1), true));
      traverse(this$static.this$0.content_0.indexedDoc, startLoc, endLoc, new Paragraph$3_0(($clinit_932() , RTL_0), true));
      $clinit_756();
      return true;
    }
  }
...
function $handleCollapsedKeyCombo(this$static, event_0, caret){
  ...
  if (this$static.this$0.keyBindings.bindings.containsKey(combo)) {
    dynamicCast(this$static.this$0.keyBindings.bindings.get(combo), 238).execute_2(this$static.this$0);
    return true;
  }
...
function $handleCommand(this$static, event_0){
  var combo;
  if ($isCombo(event_0, 90, ($clinit_655() , COMMAND))) {
    $clinit_756();
...
function $handleCopy(this$static){
  $log_0(($clinit_761() , logger_1).traceLogger, 'handling copy');
  return $clinit_756() , $handleCopyOrCutEvent(this$static.this$0.pasteExtractor, false);
}

function $handleCut(this$static){
  this$static.this$0.editorUndoManager.maybeCheckpoint();
  $log_0(($clinit_761() , logger_1).traceLogger, 'handling cut');
  return $clinit_756() , $handleCopyOrCutEvent(this$static.this$0.pasteExtractor, true);
}

function $handlePaste(this$static){
  this$static.this$0.editorUndoManager.maybeCheckpoint();
  $log_0(($clinit_761() , logger_1).traceLogger, 'handling paste');
...
function $handleTab(this$static, start, end, shiftDown){
  ...
  node = dynamicCast(start.container, 197);
  while (node) {
    if ($isTabTarget(node)) {
      break;
    }
  ...
  if (!node) {
    ...
    traverse(m_0, $getLocation_2(m_0.indexedDocLocationMapper.this$1, getFilteredPoint(m_0.this$0.persistentContentView, start)), $getLocation_2(m_0.indexedDocLocationMapper.this$1, getFilteredPoint(m_0.this$0.persistentContentView, end)), shiftDown?($clinit_925() , OUTDENTER):($clinit_925() , INDENTER));
    shiftDown?($clinit_756() , SHORTCUT_TABOUTDENT):($clinit_756() , SHORTCUT_TABINDENT);
  }
   else {
    $clinit_756();
    do {
      node = dynamicCast(getNextOrPrevNodeDepthFirst_1(this$static.this$0.content_0.mutableContent, node, null, true, !shiftDown), 197);
      if ($isTabTarget(node)) {
        break;
      }
    }
     while (node);
    if (node) {
      fixedStart = start_5(this$static.this$0.content_0.mutableContent, dynamicCast(node, 196));
...
function $isTabTarget(node){
  ...
  return ($clinit_729() , TAB_TARGETS).contains_0(nodeTagName);
}
...
function $compositionEnd(this$static){
  ...
  try {
    if (!this$static.this$0.imeExtractor.wrapper) {
      $log_0(($clinit_761() , logger_1).errorLogger, 'Composition end called with inactive ImeExtractor! Maybe caret was null initially?');
      return null;
    }
    $hackConsume(this$static.this$0.content_0.mutableContent, new Nindo_0((new Nindo$Builder_0).mutationList));
    composition = $getContent(this$static.this$0.imeExtractor);
    ...
    $rebiasSelection(this$static.this$0, ($clinit_1784() , FROM_LEFT));
...
function $compositionStart(this$static, caret){
  ...
  $supplementAnnotations(this$static.this$0.annotationLogic, $getLocation_0(this$static.this$0.content_0.mutableContent, caret), this$static.this$0.currentSelectionBias, ($clinit_1782() , PLAIN_TEXT));
}

function $deleteRange(this$static, first, second, isReplace){
  isReplace && $supplementAnnotations(this$static.this$0.annotationLogic, $getLocation_0(this$static.this$0.content_0.mutableContent, first), ($clinit_1780() , RIGHT_4), ($clinit_1782() , PLAIN_TEXT));
...
function $deleteWordEndingAt(this$static, caret){
  ...
  if (start) {
    ...
    $rebiasSelection(this$static.this$0, ($clinit_1784() , FROM_RIGHT));
  }
}
...
function $hasContentSelection(this$static){
  return $isTyping(this$static.this$0) || !!filterNonContentSelection($getHtmlSelection(this$static.this$0));
}
...
function $notifyListeners(this$static, event_0){
  var handled;
  handled = false;
  ($clinit_669() , KEY_EVENTS).contains_0(event_0.nativeEvent.type) && $editorRelevantEvent(this$static.this$0, event_0) && (handled = $fireKeyboardEvent(this$static.this$0, event_0));
  return handled;
}

function $notifyTypingExtractor_0(this$static, caret, useHtmlCaret, isReplace){
  var htmlCaret, htmlSelection;
  if (caret) {
    ...
    if (useHtmlCaret) {
      ...
      htmlCaret = htmlSelection?htmlSelection.focus_0:null;
    }
     else {
      htmlCaret = null;
    }
  ...
  if (htmlCaret) {
    !isReplace && !!caret && $supplementAnnotations(this$static.this$0.annotationLogic, $getLocation_0(this$static.this$0.content_0.mutableContent, caret), this$static.this$0.currentSelectionBias, ($clinit_1782() , PLAIN_TEXT));
    $notifyTypingExtractor(this$static.this$0, htmlCaret);
    return false;
  }
   else {
    $logPlainText(($clinit_761() , logger_1).errorLogger, "Null html caret in EditorImpl's notifyTypingExtractor, content caret: " + caret);
    return false;
  }
}
...
;
_.castableTypeMap$ = {};
_ = EditorUndoManager$1.prototype;
...
function $restoreSelectionAfterUndoRedo(this$static, transformedNonUndoable, selectionStack){
  ...
  selection = dynamicCast($pop(selectionStack), 209);
...
_ = EditorUndoManagerImpl.prototype;
...
_.redo = function redo_1(){
  ...
  if (!pair || pair.first == null) {
    $shouldLog_0(logger_2.traceLogger) && ($clinit_1659() , undefined);
    return;
  }
  redo = dynamicCast(pair.first, 207);
  transformedNonUndoable = dynamicCast(pair.second, 207);
...
_.undo = function undo_1(){
  ...
  undo = dynamicCast(pair.first, 207);
  transformedNonUndoable = dynamicCast(pair.second, 207);
  selection = $getSelectionRange(this.selectionHelper);
...
function $debugGetAllUpdateEventNames(this$static){
  ...
  events = ($clinit_2309() , defaultCollectionFactory.createStringSet());
  for (l$iterator = $iterator_20(this$static.updateListeners); l$iterator.hasNext();) {
    l_0 = dynamicCast(l$iterator.next_0(), 210);
...
function EditorUpdateEventImpl_0(editor){
  this.updateListeners = ($clinit_2326() , $clinit_2326() , new CopyOnWriteSet_0(HASH_SET));
  this.suppressedEventNames = ($clinit_2309() , defaultCollectionFactory.createStringSet());
...
function $execute_1(this$static){
  ...
  if ($isConsistent(this$static.this$0.editor)) {
    ...
    $shouldLog_0(($clinit_761() , logger_1).traceLogger) && $log_0(logger_1.traceLogger, 'Notification sent');
  }
   else {
    $shouldLog_0(($clinit_761() , logger_1).traceLogger) && $log_0(logger_1.traceLogger, 'Notification deferred for consistency reasons');
    ++this$static.delays;
...
function $getNiceHtmlRenderer(this$static, target){
  return dynamicCast(dynamicCast($inspect(this$static.data_0), 211).niceHtmlRenderers.get_4(target.tagName_0), 213);
}
...
function $endIndirectSequence(this$static){
  checkState_2(this$static.sequenceType.arrayList.size_0 != 0 && $peek_1(this$static.sequenceType) === ($clinit_784() , INDIRECT), 'end non-undoable sequence without begin');
  $pop(this$static.sequenceType);
}

function $startIndirectSequence(this$static){
  $log_2(($clinit_761() , logger_1).traceLogger, 'Depth: ', valueOf_13(this$static.sequenceType.arrayList.size_0));
  $push_2(this$static.sequenceType, ($clinit_784() , INDIRECT));
}

function $withinDirectSequence(this$static){
  return (this$static.sequenceType.arrayList.size_0 == 0?($clinit_784() , INDIRECT):dynamicCast($peek_1(this$static.sequenceType), 97)) == ($clinit_784() , DIRECT);
}
...
function $getNodeBefore(this$static){
  return this$static.offset >= 0?null:!this$static.nodeAfter?dynamicCast(this$static.container, 197).getLastChild():dynamicCast(this$static.nodeAfter, 197).prev;
}
...
function $isAtEnd(this$static){
  return this$static.offset >= 0?this$static.offset == dynamicCast(this$static.container, 225).data_0.length:!this$static.nodeAfter;
}

function $maybeMoveOut(this$static){
  var dir;
  dir = 0;
  this$static.offset >= 0?this$static.offset == 0?(dir = -1):this$static.offset >= dynamicCast(this$static.container, 225).data_0.length && (dir = 1):this$static.nodeAfter == this$static.container.getFirstChild()?(dir = -1):!this$static.nodeAfter && (dir = 1);
  if (dir != 0) {
...
function $setToBeginning(this$static, node){
  node != null && node.castableTypeMap$ && !!node.castableTypeMap$[196]?$set_6(this$static, dynamicCast(node, 196), node.getFirstChild()):$set_7(this$static, dynamicCast(node, 225), 0);
  return this$static;
}

function $setToEnd(this$static, node){
  var textNode;
  if (node != null && node.castableTypeMap$ && !!node.castableTypeMap$[196]) {
    $set_6(this$static, dynamicCast(node, 196), null);
  }
   else {
    textNode = dynamicCast(node, 225);
...
function fromPoint(point){
  return point.offset >= 0?new ContentPoint_1(dynamicCast(point.container, 225), $getTextOffset(point)):new ContentPoint_0(dynamicCast(point.container, 196), dynamicCast($getNodeAfter(point), 197));
}
...
_.equals$ = function equals_27(o){
  ...
  if (o === this)
    return true;
  if (o != null && o.castableTypeMap$ && !!o.castableTypeMap$[227]) {
    point = dynamicCast(o, 227);
...
_.toString$ = function toString_60(){
  return '(' + $toString_17(this.container) + ':' + (this.offset >= 0?valueOf_13(this.offset):this.nodeAfter) + ')';
}
;
_.castableTypeMap$ = {227:1};
_.container = null;
_.nodeAfter = null;
_.offset = 0;
...
function $handleBackspaceAfterNode(this$static, node, event_0){
  ...
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleBackspaceAfterNode(element, event_0)) {
    return true;
  }
   else {
...
function $handleBackspaceAtBeginning_0(this$static, node, event_0){
  var element;
  element = node.asElement();
  return !!element && dynamicCast(element, 223).nodeEventHandler.handleBackspaceAtBeginning(element, event_0) || $handleBackspace(this$static, $setToBefore(event_0.caret, node).container, event_0);
}
...
function $handleBackspaceNotAtBeginning(this$static, node, event_0){
  ...
  if (!element) {
   ...
   else if (dynamicCast(element, 223).nodeEventHandler.handleBackspaceNotAtBeginning(element, event_0)) {
    return true;
  }
   else {
    childBefore = $getNodeBefore(event_0.caret, ($clinit_853() , INSTANCE_6));
...
function $handleClick(this$static, node, event_0){
  ...
  element = node;
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleClick(element, event_0)) {
    return true;
  }
   else {
...
function $handleDelete(this$static, node, event_0){
  ...
  element = node.asElement();
  return !!element && dynamicCast(element, 223).nodeEventHandler.handleDelete(element, event_0) || ($isAtEnd(event_0.caret)?(element_0 = node.asElement() , !!element_0 && dynamicCast(element_0, 223).nodeEventHandler.handleDeleteAtEnd(element_0, event_0) || $handleDelete(this$static, $setToAfter(event_0.caret, node).container, event_0)):$handleDeleteNotAtEnd(this$static, node, event_0));
}

function $handleDeleteBeforeNode(this$static, node, event_0){
  var element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleDeleteBeforeNode(element, event_0)) {
    return true;
  }
   else {
...
function $handleDeleteNotAtEnd(this$static, node, event_0){
  ...
  if (!element) {
   ...
   else if (dynamicCast(element, 223).nodeEventHandler.handleDeleteNotAtEnd(element, event_0)) {
    return true;
  }
   else {
...
function $handleEnter(this$static, node, event_0){
  var element, parent_0;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleEnter(element, event_0)) {
    return true;
  }
   else {
    parent_0 = node.parent_0;
...
function $handleLeft(this$static, node, event_0){
  ...
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleLeft(element, event_0)) {
    return true;
  }
   else {
    caret = event_0.caret;
    if (caret.offset >= 0?caret.offset == 0:caret.nodeAfter == caret.container.getFirstChild()) {
      ...
      child = $getNodeBefore(caret, ($clinit_853() , INSTANCE_6));
...
function $handleLeftAfterNode(node, event_0){
  var element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleLeftAfterNode(element, event_0)) {
    return true;
  }
   else {
    event_0.shouldAllowDefault = true;
...
function $handleLeftAtBeginning(this$static, node, event_0){
  var element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleLeftAtBeginning(element, event_0)) {
    return true;
  }
   else {
...
function $handleRight(this$static, node, event_0){
  var caret, child, element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleRight(element, event_0)) {
    return true;
  }
   else {
    caret = event_0.caret;
    if (caret.offset >= 0?caret.offset == dynamicCast(caret.container, 225).data_0.length:!caret.nodeAfter) {
...
function $handleRightAtEnd(this$static, node, event_0){
  var element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleRightAtEnd(element, event_0)) {
    return true;
  }
   else {
...
function $handleRightBeforeNode(node, event_0){
  var element;
  element = node.asElement();
  if (!!element && dynamicCast(element, 223).nodeEventHandler.handleRightBeforeNode(element, event_0)) {
    return true;
  }
   else {
    event_0.shouldAllowDefault = true;
...
function handleTextNodeDeleteAction(node, event_0, isBackSpace){
  ...
  if (node.data_0.length <= 1) {
    ...
    if (isBackSpace) {
      a_0 = new Point$Tx_0(dynamicCast(caret.container, 197), $getTextOffset(caret) - 1);
      b = caret;
    }
     else {
      a_0 = caret;
      b = new Point$Tx_0(dynamicCast(caret.container, 197), $getTextOffset(caret) + 1);
    }
...
function indent_3(p, delta){
  $clinit_776();
  var indent;
  indent = max_1(0, ($clinit_925() , getIndent(dynamicCast(p.attributes.get_4('i'), 1))) + delta);
...
function $handleBackspaceAtBeginning_1(paragraph){
  ...
  line = ($clinit_913() , dynamicCast(paragraph.transientData.get_0(LINE_0.id_0), 230));
...
_.handleDeleteAtEnd = function handleDeleteAtEnd_3(p, event_0){
  var line;
  line = ($clinit_913() , dynamicCast(p.transientData.get_0(LINE_0.id_0), 230));
...
_.handleEnter = function handleEnter_1(element, event_0){
  ...
  point.offset >= 0?dynamicCast(point.container, 197):dynamicCast(nodeBefore_0(($clinit_853() , INSTANCE_6), point.asElementPoint()), 197);
  line = ($clinit_913() , dynamicCast(element.transientData.get_0(LINE_0.id_0), 230));
  if (of_0(dynamicCast(element.attributes.get_4('t'), 1)) == ($clinit_937() , LIST) && (lineElement = dynamicCast(element.transientData.get_0(LINE_0.id_0), 230).lineElement , doc_0 = lineElement.context.this$0.mutableContent , next = dynamicCast(doc_0.doc.substrate.getNextSibling(lineElement), 197) , !next || !!next.asElement() && ($clinit_916() , $equals_3('line', next.asElement().tagName_0)))) {
  ...
  secondAttrs.size_1() == 0 && (secondAttrs = ($clinit_1880() , EMPTY_MAP_0));
  newLineElement = dynamicCast($createElement_1(doc, $locate(doc, (checkNotNull_1(point, 'getLocation: Null point') , doc.doc.getLocation_0(point))), 'line', secondAttrs), 196);
  newLocalParagraph = dynamicCast(newLineElement.transientData.get_0(LINE_0.id_0), 230).paragraph;
...
function getFirstLine(mapper, start){
  ...
  doc = dynamicCast(point.container, 197).context.this$0.mutableContent;
  $clinit_2135();
  checkArgument_2(!isUnsupportedParagraphDocument(doc), 'Paragraph docs no longer supported');
  first = dynamicCast(getRelatedLineElement(doc, point), 197);
  if (!first) {
    return null;
  }
  return $clinit_913() , dynamicCast(first.asElement().transientData.get_0(LINE_0.id_0), 230);
}
...
;
_.execute_3 = function execute_29(e){
...
function $renderHeadingItem(view, dest, src, selectionMatcher){
  var e, tagName;
  e = $doc.createElement('h' + ($clinit_925() , tagName = dynamicCast(src.attributes.get_4('t'), 1) , tagName.charCodeAt(1) - 48));
  dest.appendChild(e);
...
_.renderSequence = function renderSequence(view, firstItem, stopAt, destParent, selectionMatcher){
  ...
  checkArgument_3(firstItem != null && firstItem.castableTypeMap$ && !!firstItem.castableTypeMap$[196], 'firstItem must be an instance of ContentElement ', initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, [firstItem.getClass$()]));
  prev = null;
  helper = new ParagraphNiceHtmlRenderer$HtmlStack_0(destParent);
  for (node = firstItem; !!node && node != stopAt; prev = node , node = dynamicCast(view.getNextSibling(node), 197)) {
    el = dynamicCast(node, 196);
    indent = ($clinit_925() , getIndent(dynamicCast(el.attributes.get_4('i'), 1)));
    if (isHeading(el)) {
      ...
      $restack(helper, ($clinit_945() , BLOCKQUOTE), indent);
      ...
      if (($clinit_916() , $equals_3(el.tagName_0, 'l:p')) && $equals_3('li', dynamicCast(el.attributes.get_4('t'), 1))) {
        isDecimal = $equals_3('li', dynamicCast(el.attributes.get_4('t'), 1)) && $equals_3('decimal', dynamicCast(el.attributes.get_4('listyle'), 1));
        $equalsIgnoreCase((helper.elementStack.size_0 == 0?helper.topParent:dynamicCastJso($get_7(helper.elementStack, helper.elementStack.size_0 - 1))).tagName, 'li') && $remove_12(helper.elementStack, helper.elementStack.size_0 - 1);
        $restack(helper, isDecimal?($clinit_945() , OL):($clinit_945() , UL), indent + 1);
...
function $clinit_945(){
  ...
  $VALUES_28 = initValues(_3Lorg_waveprotocol_wave_client_editor_content_paragraph_ParagraphNiceHtmlRenderer$IndentType_2_classLit, {9:1, 68:1, 170:1}, 105, [BLOCKQUOTE, UL, OL]);
}

function valueOf_35(name_0){
  $clinit_945();
  return valueOf_0(($clinit_949() , $MAP_28), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 105:1};
var $VALUES_28, BLOCKQUOTE, OL, UL;
...
_.castableTypeMap$ = {9:1, 10:1, 65:1, 105:1};
function $clinit_949(){
  $clinit_949 = nullMethod;
  $MAP_28 = createValueOfMap(($clinit_945() , $VALUES_28));
}

var $MAP_28;
function $setEnabled(this$static, enabled){
  if (enabled) {
    $add_31(this$static.editorImpl.updateEvent.updateListeners, this$static);
  }
   else {
...
_.onUpdate = function onUpdate_0(event_0){
  var p, parent_0, parent_1;
  p = ($clinit_1046() , $getFocusPosition());
  if (p) {
    $log_0(($clinit_761() , logger_1).traceLogger, 'x: ' + p.left_0 + 'y: ' + p.top_0);
    if (!p.offsetParent_0) {
      (parent_0 = this.DEBUG_CURSOR.parentNode , (!parent_0 || parent_0.nodeType != 1) && (parent_0 = null) , parent_0) != $doc.body && $doc.body.appendChild(this.DEBUG_CURSOR);
      this.DEBUG_CURSOR.style['top'] = p.top_0 - $getAbsoluteTop($doc.body) + ($clinit_88() , 'px');
      this.DEBUG_CURSOR.style['left'] = p.left_0 - $getAbsoluteLeft($doc.body) + 'px';
    }
     else {
      !!this.editorImpl.element && (parent_1 = this.DEBUG_CURSOR.parentNode , (!parent_1 || parent_1.nodeType != 1) && (parent_1 = null) , parent_1) != this.editorImpl.element && this.editorImpl.element.appendChild(this.DEBUG_CURSOR);
      this.DEBUG_CURSOR.style['top'] = p.top_0 + ($clinit_88() , 'px');
      this.DEBUG_CURSOR.style['left'] = p.left_0 + 'px';
    }
  }
}
;
...
function $onShow(this$static){
  switch (this$static.previousSelection.ordinal) {
    ...
    case 2:
    case 3:
      $add_31(this$static.editorImpl.updateEvent.updateListeners, this$static.updateListener);
...
function $setChecked_0(this$static, button){
  $setValue_1(button, ($clinit_428() , $clinit_428() , TRUE_0));
  button == this$static.domButton?$setNewSelection(this$static, ($clinit_958() , DOM_0)):button == this$static.localXmlButton?$setNewSelection(this$static, ($clinit_958() , LOCAL_XML)):button == this$static.persistenDocumentButton?$setNewSelection(this$static, ($clinit_958() , PERSISTENT_DOCUMENT)):button == this$static.annotationButton?$setNewSelection(this$static, ($clinit_958() , ANNOTATIONS)):button == this$static.logButton?$setNewSelection(this$static, ($clinit_958() , LOG_0)):button == this$static.optionsButton && $setNewSelection(this$static, ($clinit_958() , OPTIONS));
}
...
function DebugDialog_0(editorImpl){
  ...
  this.domButton = new RadioButton_1(this.groupName, ($clinit_958() , DOM_0).displayName);
  ...
  this.logPanel = new DebugDialog$LogPanel_0(($clinit_691() , logbuffer));
  ...
  $addDomHandler(this.domButton, this.radioButtonHandler, ($clinit_116() , $clinit_116() , TYPE_1));
...
_.onClick = function onClick_0(e){
  $setChecked_0(this.this$0, dynamicCast(e.source, 232));
}
;
_.castableTypeMap$ = {24:1, 38:1};
_.this$0 = null;
...
function $clinit_958(){
  ...
  $VALUES_29 = initValues(_3Lorg_waveprotocol_wave_client_editor_debug_DebugDialog$Selection_2_classLit, {9:1, 68:1, 170:1}, 106, [LOCAL_XML, DOM_0, PERSISTENT_DOCUMENT, ANNOTATIONS, LOG_0, OPTIONS]);
}
...
function valueOf_36(name_0){
  $clinit_958();
  return valueOf_0(($clinit_959() , $MAP_29), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 106:1};
_.displayName = null;
var $VALUES_29, ANNOTATIONS, DOM_0, LOCAL_XML, LOG_0, OPTIONS, PERSISTENT_DOCUMENT;
function $clinit_959(){
  $clinit_959 = nullMethod;
  $MAP_29 = createValueOfMap(($clinit_958() , $VALUES_29));
}
...
function $addCheckBox_0(panel, caption, initValue, handler){
  ...
  $setValue_1(box, ($clinit_428() , initValue?TRUE_0:FALSE_0));
...
function DebugOptions_0(editorImpl){
  ...
  $addCheckBox_0(this.optionsPanel, 'Cancel unsafe combos', ($clinit_977() , $clinit_977() , cancelUnsafeKeyEvents), new DebugOptions$3_0);
  $addCheckBox_0(this.optionsPanel, 'Show xy-selection cursor', cursorDisplay.enabled, new DebugOptions$4_0(cursorDisplay));
  $addCheckBox_0(this.optionsPanel, 'Check local ops', ($clinit_811() , validateLocalOps), new DebugOptions$5_0);
  ...
  $addDomHandler(insertXmlButton, new DebugOptions$6_0(this, errorLabel, contentInput), ($clinit_116() , $clinit_116() , TYPE_1));
...
_.onValueChange = function onValueChange_0(event_0){
  this.val$editorImpl.debugDisabled = !dynamicCast(event_0.value_0, 62).value_0;
}
;
_.castableTypeMap$ = {37:1, 38:1};
...
_.onValueChange = function onValueChange_1(event_0){
  $debugConnectOpSinks(this.val$editorImpl, dynamicCast(event_0.value_0, 62).value_0);
}
;
_.castableTypeMap$ = {37:1, 38:1};
_.val$editorImpl = null;
...
_.onValueChange = function onValueChange_2(event_0){
  $clinit_977();
  cancelUnsafeKeyEvents = dynamicCast(event_0.value_0, 62).value_0;
}
;
_.castableTypeMap$ = {37:1, 38:1};
...
_.onValueChange = function onValueChange_3(event_0){
  $setEnabled(this.val$cursorDisplay, dynamicCast(event_0.value_0, 62).value_0);
}
;
_.castableTypeMap$ = {37:1, 38:1};
...
_.onValueChange = function onValueChange_4(event_0){
  $clinit_811();
  validateLocalOps = dynamicCast(event_0.value_0, 62).value_0;
}
;
_.castableTypeMap$ = {37:1, 38:1};
...
_.onClick = function onClick_1(event_0){
  ...
  $focus_1(this.this$0.editor, true);
  selection = (selection_0 = $getSelectionPoints($getSelectionHelper_0(this.this$0.editor)) , !selection_0?null:$asOrderedRange(selection_0, ($clinit_1046() , $isOrdered())));
  if (!selection) {
    $setTextOrHtml(this.val$errorLabel.directionalTextHelper, "Don't know where to insert this", false);
    return;
  }
  try {
    xml = innerXml1($parse_1(($clinit_2112() , $getPropertyString(this.val$contentInput.element, 'value'))));
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 21)) {
...
_.onValueChange = function onValueChange_5(event_0){
  $debugSuppressUpdateEvent(this.val$updates, this.val$element, !dynamicCast(event_0.value_0, 62).value_0);
}
;
_.castableTypeMap$ = {37:1, 38:1};
_.val$element = null;
...
function create_21(editorImpl){
  var debugDialog, listener, popup, positioner;
  debugDialog = new DebugDialog_0(editorImpl);
  positioner = new DebugPopupFactory$1_0;
  listener = new DebugPopupFactory$2_0(debugDialog);
  popup = createPopup_0(positioner, false, debugDialog, listener);
...
_.setPopupPositionAndMakeVisible = function setPopupPositionAndMakeVisible(reference, popup){
  ...
  popupStyle['top'] = 50 + ($clinit_88() , 'px');
  popupStyle['left'] = '50px';
  popupStyle['visibility'] = ($clinit_99() , 'visible');
  popupStyle['position'] = ($clinit_82() , 'fixed');
}
;
_.castableTypeMap$ = {};
...
_.this$0 = null;
function $clinit_977(){
  $clinit_977 = nullMethod;
  logger_4 = ($clinit_761() , logger_1);
}
  ...
  if (signal.nativeEvent.target.nodeType == 3 && ($equals_3(signal.nativeEvent.type, 'DOMCharacterDataModified') || $equals_3(signal.nativeEvent.type, 'DOMNodeInserted'))) {
    ...
    if (textNode.length > 0) {
      ...
      if (!!e && e.nodeType != 3 && $equals_3(e.tagName.toLowerCase(), 'a')) {
        selection = $getHtmlSelection(this$static.editorInteractor.this$0);
...
function $checkIfValidSelectionNeeded(this$static, event_0){
  if (event_0.nativeEvent.type.indexOf('DOM') == 0 || ($clinit_669() , FOCUS_EVENTS).contains_0(event_0.nativeEvent.type)) {
    return false;
  }
   else if (($clinit_669() , KEY_EVENTS).contains_0(event_0.nativeEvent.type) && this$static.state == ($clinit_980() , NORMAL_0)) {
    if (event_0.cachedKeyCode == 229) {
      return false;
    }
     else if (event_0.keySignalType == ($clinit_665() , INPUT)) {
      return false;
    }
  }
  return true;
...
function $compositionEnd_1(this$static){
  ...
  this$static.state = ($clinit_980() , NORMAL_0);
}

function $compositionStart_1(this$static){
  var caret;
  this$static.state == ($clinit_980() , COMPOSITION) && $log_0(logger_4.errorLogger, 'State was already IME during a compositionstart event!');
...
function $deleteCachedSelectionRangeAndInvalidate(this$static, isReplace){
  ...
  if ($isOrdered()) {
    ...
    end = this$static.cachedSelection.anchor;
    start = this$static.cachedSelection.focus_0;
  }
...
function $handleEvent(this$static, signal){
  ...
  try {
    ...
    $e0 = caught_0($e0);
    if (instanceOf($e0, 233)) {
      e = $e0;
      e.lostSelection && selectionLogCullRotation++ % 100 == 0 && $log_3(($clinit_761() , logger_1).errorLogger, e);
...
function $handleEventInner(this$static, event_0){
  var node;
  this$static.cachedSelection = null;
  if (($clinit_669() , MOUSE_EVENTS).contains_0(event_0.nativeEvent.type)) {
    ...
    if (!!node && $equals_3('click', event_0.nativeEvent.type)) {
      ...
      $rebiasSelection(this$static.editorInteractor.this$0, ($clinit_1784() , NEUTRAL_0));
  ...
  this$static.weirdComposition && this$static.state == ($clinit_980() , COMPOSITION) && (COMPOSITION_EVENTS.contains_0(event_0.nativeEvent.type) || $handleOtherEvent(this$static.compositionHandler));
  if (KEY_EVENTS.contains_0(event_0.nativeEvent.type)) {
    ...
    ($clinit_649() , LIES_ABOUT_CARET_AT_LINK_END_BOUNDARY) && $checkForWebkitEndOfLinkHack(this$static, event_0);
...
function $handleEventsManuallyOnNode(this$static, event_0, caret){
  if ($isCombo(event_0, 13, ($clinit_655() , NONE_0))) {
    $refreshEditorWithCaret(this$static, event_0);
    caret = $asPoint(event_0.caret);
    $checkpoint(this$static.editorInteractor, new FocusedContentRange_1(caret));
    $handleEnter(this$static.router, dynamicCast(caret.container, 197), event_0);
    $rebiasSelection(this$static.editorInteractor.this$0, ($clinit_1784() , FROM_LEFT));
    return true;
  }
...
function $handleInputOrDeleteKeyEvent(this$static, event_0, keySignalType){
  ...
  isCollapsed = !!$getHtmlSelection(this$static.editorInteractor.this$0) && $getHtmlSelection(this$static.editorInteractor.this$0).isCollapsed;
  isReplace = false;
  if (isCollapsed) {
    moveUnit = event_0.keySignalType == ($clinit_665() , DELETE_0)?($clinit_682() , $clinit_682() , INSTANCE_4).isMac?event_0.nativeEvent.altKey?($clinit_667() , WORD):(($clinit_669() , logic_0).commandIsCtrl?!!event_0.nativeEvent.ctrlKey:!!event_0.nativeEvent.metaKey)?($clinit_667() , LINE):($clinit_667() , CHARACTER):(($clinit_669() , logic_0).commandIsCtrl?!!event_0.nativeEvent.ctrlKey:!!event_0.nativeEvent.metaKey)?($clinit_667() , WORD):($clinit_667() , CHARACTER):($clinit_667() , CHARACTER);
    if (moveUnit != ($clinit_667() , CHARACTER)) {
      if ((event_0.keySignalType == DELETE_0?($clinit_682() , $clinit_682() , INSTANCE_4).isMac?event_0.nativeEvent.altKey?WORD:(($clinit_669() , logic_0).commandIsCtrl?!!event_0.nativeEvent.ctrlKey:!!event_0.nativeEvent.metaKey)?LINE:CHARACTER:(($clinit_669() , logic_0).commandIsCtrl?!!event_0.nativeEvent.ctrlKey:!!event_0.nativeEvent.metaKey)?WORD:CHARACTER:CHARACTER) == WORD) {
    ...
    $refreshEditorWithCaret(this$static, event_0);
    isDelete = keySignalType == ($clinit_665() , DELETE_0);
  ...
  if (keySignalType == ($clinit_665() , DELETE_0)) {
    $refreshEditorWithCaret(this$static, event_0);
    caret = this$static.cachedSelection.focus_0;
    node = dynamicCast(caret.container, 197);
    $checkpoint(this$static.editorInteractor, new FocusedContentRange_1(caret));
    switch (($clinit_607() , getKeyCombo_0(event_0.cachedKeyCode, !!event_0.nativeEvent.ctrlKey, !!event_0.nativeEvent.shiftKey, !!event_0.nativeEvent.altKey, !!event_0.nativeEvent.metaKey)).ordinal) {
      case 21:
      case 22:
        $rebiasSelection(this$static.editorInteractor.this$0, ($clinit_1784() , FROM_RIGHT));
        return $handleBackspace(this$static.router, node, event_0);
      case 24:
        if ($clinit_649() , HAS_OLD_SCHOOL_CLIPBOARD_SHORTCUTS) {
...
function $handleKeyEvent(this$static, event_0){
  ...
  switch (this$static.state.ordinal) {
    case 0:
      if (isAcceleratorInner(event_0, ($clinit_682() , $clinit_682() , INSTANCE_4).isMac, ($clinit_649() , HAS_OLD_SCHOOL_CLIPBOARD_SHORTCUTS))) {
        $refreshEditorWithCaret(this$static, event_0);
        if ($handleCommand(this$static.subHandler, event_0) || $handleBlockLevelCommands(this$static.subHandler, event_0, $asOrderedRange(this$static.cachedSelection, ($clinit_1046() , $isOrdered())))) {
          return true;
        }
        if (this$static.cachedSelection.isCollapsed) {
          ...
          if ($handleRangeKeyCombo(this$static.subHandler, event_0, $asOrderedRange(this$static.cachedSelection, ($clinit_1046() , $isOrdered())))) {
            return true;
          }
        }
...
function $handleNavigationKeyEvents(this$static, event_0){
  ...
  this$static.editorInteractor.this$0.caretStyles.annotations.clear();
  node = dynamicCast(this$static.cachedSelection.focus_0.container, 197);
...
function $isAlternateClipboardCombo(signal){
  switch (($clinit_607() , getKeyCombo_0(signal.cachedKeyCode, !!signal.nativeEvent.ctrlKey, !!signal.nativeEvent.shiftKey, !!signal.nativeEvent.altKey, !!signal.nativeEvent.metaKey)).ordinal) {
    case 24:
    case 27:
    case 26:
      return true;
...
function $isBlackListedCombo(event_0){
  var keyCombo;
  keyCombo = ($clinit_607() , getKeyCombo_0(event_0.cachedKeyCode, !!event_0.nativeEvent.ctrlKey, !!event_0.nativeEvent.shiftKey, !!event_0.nativeEvent.altKey, !!event_0.nativeEvent.metaKey));
  if (keyCombo.ordinal == 44) {
    return true;
  }
  if (($clinit_682() , $clinit_682() , INSTANCE_4).isMac) {
  ...
  if (keyCombo == ($clinit_633() , ORDER_ALT_SHIFT_V)) {
    return true;
  }
  return false;
}
...
function $isWhiteListedCombo(signal){
  var keyCombo;
  keyCombo = ($clinit_607() , getKeyCombo_0(signal.cachedKeyCode, !!signal.nativeEvent.ctrlKey, !!signal.nativeEvent.shiftKey, !!signal.nativeEvent.altKey, !!signal.nativeEvent.metaKey));
  switch (keyCombo.ordinal) {
    case 41:
    case 42:
    case 43:
...
function $shouldCancelAcceleratorBrowserDefault(this$static, acceleratorEvent){
  if ($check(($clinit_655() , acceleratorEvent))) {
  ...
  $shouldLog_0(logger_4.traceLogger) && $log_1(logger_4.traceLogger, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, ['unsafe combo: ', acceleratorEvent.nativeEvent.type, valueOf_13(acceleratorEvent.cachedKeyCode)]));
...
function EditorEventHandler_0(editorInteractor, subHandler, router, useWhiteListFlag, useWebkitCompositionFlag){
  $clinit_977();
  EditorEventHandler_1.call(this, new SchedulerTimerService_1((!instance_7 && (instance_7 = new BrowserBackedScheduler_0 , setDefaultTimerService() , undefined) , instance_7), ($clinit_1200() , CRITICAL)), editorInteractor, subHandler, router, useWhiteListFlag, ($clinit_649() , SUPPORTS_COMPOSITION_EVENTS) && useWebkitCompositionFlag);
}
...
function EditorEventHandler_1(criticalTimerService, interactor, subHandler, router, useWhiteListing, useCompositionEvents){
  ...
  this.weirdComposition = ($clinit_649() , true);
  this.state = ($clinit_980() , NORMAL_0);
...
function isAcceleratorInner(event_0, isMac, quirksHasOldSchoolClipboardShortcuts){
  ...
  switch (event_0.keySignalType.ordinal) {
    ...
    case 2:
      return quirksHasOldSchoolClipboardShortcuts && event_0.cachedKeyCode == 46 && $check_0(($clinit_655() , event_0));
    case 1:
      return false;
    case 3:
      return true;
...
;
_.castableTypeMap$ = {9:1, 39:1, 183:1, 233:1};
_.lostSelection = false;
function $clinit_980(){
  $clinit_980 = nullMethod;
  NORMAL_0 = new EditorEventHandler$State_0('NORMAL', 0);
  COMPOSITION = new EditorEventHandler$State_0('COMPOSITION', 1);
  $VALUES_30 = initValues(_3Lorg_waveprotocol_wave_client_editor_event_EditorEventHandler$State_2_classLit, {9:1, 68:1, 170:1}, 107, [NORMAL_0, COMPOSITION]);
}
...
function valueOf_37(name_0){
  $clinit_980();
  return valueOf_0(($clinit_981() , $MAP_30), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 107:1};
var $VALUES_30, COMPOSITION, NORMAL_0;
function $clinit_981(){
  $clinit_981 = nullMethod;
  $MAP_30 = createValueOfMap(($clinit_980() , $VALUES_30));
}

var $MAP_30;
function $clinit_982(){
  $clinit_982 = nullMethod;
  $clinit_669();
...
function $handleMutationEvent(this$static, event_0){
  ...
  if ($equals_3(event_0.nativeEvent.type, 'DOMNodeRemoved')) {
    target = event_0.nativeEvent.target;
    ignorableWhenEmpty = target.nodeType == 3 || ($clinit_1033() , !(!!target && (target[BACKREF_NAME] || null) != null));
    if (ignorableWhenEmpty && this$static.entries.size_0 == 0)
    ;
    else {
      $log_0(($clinit_761() , logger_1).traceLogger, 'REVERT REMOVAL: ' + (target.nodeType == 3?target.data:target.tagName));
...
function $activate_0(this$static, cxt, location_0){
  ...
  container = dynamicCast(point.container, 197).asElement();
  nodeAfter = dynamicCast($getNodeAfter(point), 197);
  !!nodeAfter && (container = nodeAfter.parent_0);
  this$static.wrapper = $transparentCreate_0(cxt.this$0.fullContentView, 'l:ime', ($clinit_480() , $clinit_480() , EMPTY_MAP), container, nodeAfter);
  this$static.wrapper.containerNodelet.appendChild(this$static.imeContainer);
  setCaret(this$static.inContainer);
}

function $clearContainer(this$static){
  this$static.imeInput.innerHTML = '';
  $appendSpacer(($clinit_939() , this$static.imeInput));
  this$static.inContainer = new Point$El_0(this$static.imeInput, this$static.imeInput.firstChild);
}
...
function $deactivate(this$static, doc){
  var ret;
  ret = new Point$El_0(dynamicCast(doc.inner_0.getParentElement(this$static.wrapper), 197), dynamicCast(doc.inner_0.getNextSibling(this$static.wrapper), 197));
...
function ImeExtractor_0(){
  ...
  $clinit_1033();
  this.imeContainer[TRANSPARENCY] = ($clinit_2121() , DEEP);
...
function $filterContentAnnotations(this$static, known){
  var interested;
  interested = ($clinit_2309() , defaultCollectionFactory.createStringSet());
...
function $stripKeys(this$static, annotationSet, position, cursorBias, type, builder){
  ...
  before = ($clinit_2309() , defaultCollectionFactory.createStringMap());
  ...
  inside = cursorBias == ($clinit_1780() , RIGHT_4)?after:before;
...
_.apply_4 = function apply_41(key){
  ...
  !!behaviour && behaviour.getAnnotationFamily() == ($clinit_1778() , CONTENT_0) && this.val$interested.add_3(key);
}
;
...
function $extract(this$static, srcContainer, previousSelection, cursorBias){
  ...
  cursorBias = ($clinit_1780() , LEFT_4);
  if (this$static.useSemanticCopyPaste && waveXml != null) {
    if (waveXml.length) {
      $clinit_756();
      builder = $at_0(pos);
      createdFromXmlString = createFromXmlStringWithContraints(waveXml, ($clinit_2011() , BLIP_TEXT));
      modified = $stripKeys(this$static.annotationLogic, destDoc, pos, cursorBias, ($clinit_1782() , RICH_TEXT), builder);
      startTime = (new Date).getTime();
      appendXmlToBuilder(createdFromXmlString, builder);
      timeTaken = (new Date).getTime() - startTime;
      $log_0(LOG_1.traceLogger, 'time taken: ' + timeTaken);
      $unstripKeys(builder, modified.keySet_1(), ($clinit_2309() , defaultCollectionFactory.createStringSet()));
      ...
      try {
        ...
        $push_2(destOperationSequencer.responsibility.sequenceType, ($clinit_784() , DIRECT));
    ...
    affectedKeys = $applyMutations(mutationBuilder, tokenizer, builder, destDoc, dynamicCast(end.container, 197));
  ...
  srcContainer.innerHTML = '';
  focus_16(dynamicCast(destDoc.doc.substrate.getDocumentElement(), 196).containerNodelet);
}

function $handleCopyOrCutEvent(this$static, isCut){
  var contentSelection, selection, selection_0;
  contentSelection = (selection_0 = $getSelectionPoints(this$static.aggressiveSelectionHelper) , !selection_0?null:$asOrderedRange(selection_0, ($clinit_1046() , $isOrdered())));
  if (!contentSelection) {
    return true;
  }
...
function $handlePasteEvent(this$static, cursorBias){
  ...
  previousSelection = (selection = $getSelectionPoints(this$static.aggressiveSelectionHelper) , !selection?null:$asOrderedRange(selection, ($clinit_1046() , $isOrdered())));
...
function $performCopyOrCut(this$static, contentSelection, isCut){
  ...
  commonAncestor = dynamicCast(nearestCommonAncestor_0(this$static.renderedContent, dynamicCast(first.container, 197), dynamicCast(second.container, 197)), 197);
...
_.execute_0 = function execute_32(){
  $extract(this.this$0, $getPasteContainer(($clinit_1000() , pasteBuffer_0)), this.val$previousSelection, this.val$cursorBias);
...
function getSemanticHandler(node){
  var element, handler;
  if (node != null && node.castableTypeMap$ && !!node.castableTypeMap$[223]) {
    element = dynamicCast(node, 223);
    handler = $getNiceHtmlRenderer(element.registry, element);
    return handler?handler:($clinit_1004() , DEEP_CLONE_RENDERER);
  }
   else {
    return $clinit_1004() , DEEP_CLONE_RENDERER;
  }
}
...
function renderChildren(view, parent_0, contentParent, selectionMatcher){
  ...
  while (current) {
    ...
    current = dynamicCast(view.getNextSibling(done), 197);
  }
}
...
_.renderSequence = function renderSequence_1(view, firstItem, stopAt, dstParent, selectionMatcher){
  ...
  firstItem != null && firstItem.castableTypeMap$ && !!firstItem.castableTypeMap$[196] && $log_0(($clinit_761() , logger_1).traceLogger, 'deep cloning: ' + dynamicCast(firstItem, 196).tagName_0);
...
_.renderSequence = function renderSequence_2(view, firstItem, stopAt, dstParent, selectionMatcher){
  ...
  if (firstItem != null && firstItem.castableTypeMap$ && !!firstItem.castableTypeMap$[196]) {
...
function $handleInserted(this$static, error){
  $log_4(($clinit_761() , logger_1).errorLogger, 'handleInserted: ', error);
  $revert(this$static, error.contentPoint, null);
}

function $getCorespondingPointInEmptyElement(selection, source, clone){
  return source != null && source.castableTypeMap$ && !!source.castableTypeMap$[196] && !source.getFirstChild() && $equals_11(selection, new Point$El_0(source, null))?clone?new SelectionMatcher$EagerPoint_0(new Point$El_0(clone, null)):new SelectionMatcher$EagerPoint_0(new Point$El_0($getParentElement(null), null)):null;
}
...
function $maybeNoteHtml(this$static, source, clone){
  ...
  if (!this$static.htmlStart) {
    $equals_11(this$static.contentStart, new Point$El_0(source.parent_0, source))?(this$static.htmlStart = new SelectionMatcher$LazyPointImpl_0(clone, ($clinit_1012() , BEFORE_NODE))):$equals_11(this$static.contentStart, new Point$El_0(source.parent_0, source.next)) && (this$static.htmlStart = new SelectionMatcher$LazyPointImpl_0(clone, ($clinit_1012() , AFTER_NODE)));
  ...
  if (!this$static.htmlEnd) {
    $equals_11(this$static.contentEnd, new Point$El_0(source.parent_0, source))?(this$static.htmlEnd = new SelectionMatcher$LazyPointImpl_0(clone, ($clinit_1012() , BEFORE_NODE))):$equals_11(this$static.contentEnd, new Point$El_0(source.parent_0, source.next)) && (this$static.htmlEnd = new SelectionMatcher$LazyPointImpl_0(clone, ($clinit_1012() , AFTER_NODE)));
...
function $clinit_1012(){
  ...
  $VALUES_31 = initValues(_3Lorg_waveprotocol_wave_client_editor_extract_SelectionMatcher$LazyPoint$Type_2_classLit, {9:1, 68:1, 170:1}, 108, [BEFORE_NODE, AFTER_NODE, AT_START]);
}
...
function valueOf_38(name_0){
  $clinit_1012();
  return valueOf_0(($clinit_1013() , $MAP_31), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 108:1};
var $VALUES_31, AFTER_NODE, AT_START, BEFORE_NODE;
function $clinit_1013(){
  $clinit_1013 = nullMethod;
  $MAP_31 = createValueOfMap(($clinit_1012() , $VALUES_31));
}
...
function $augmentBuilder(this$static, node, inclusion){
  ...
  builder = new XmlStringBuilderDoc_0(null, ($clinit_2011() , ANY));
  ...
  if (this$static.doc.doc.substrate.asElement_0(node) != null) {
    ...
    $wrap_1(builder, this$static.doc.doc.substrate.getTagName(asElement), ($clinit_2309() , new CollectionUtils$StringMapAdapter_0(this$static.doc.doc.substrate.getAttributes(asElement))));
  }
   else {
...
function $renderRange(this$static, start, end){
  ...
  builder = new XmlStringBuilderDoc_0(null, ($clinit_2011() , BLIP_TEXT));
  ...
  if (asElement != null) {
    ...
    (asElement == null?null:asElement) !== maskUndefined(this$static.doc.doc.substrate.getDocumentElement()) && $shouldInclude(inclusion, new Range_2(this$static.doc.doc.getLocation(asElement), $getNodeEnd(this$static, asElement))) && $wrap_1(builder, this$static.doc.doc.substrate.getTagName(asElement), ($clinit_2309() , new CollectionUtils$StringMapAdapter_0(this$static.doc.doc.substrate.getAttributes(asElement))));
  }
   else {
...
function $getFreshTypingState(this$static){
  ...
  if (this$static.numStates > this$static.statePool.size_0) {
    ...
    return dynamicCast($get_7(this$static.statePool, this$static.numStates - 1), 235);
  }
}
...
function $checkNeighbouringTextNodes(this$static, previousSelectionStart){
  ...
  try {
    ...
    if (selOffset == 0 && this$static.firstWrapper.implNodelet == selNode) {
      prev = dynamicCast($getPreviousSibling_3(renderedContent, this$static.firstWrapper), 197);
      !!prev && prev.isTextNode() && (this$static.firstWrapper = dynamicCast(prev, 225));
    }
     else {
      nextNode = dynamicCast($getNextSibling_3(renderedContent, this$static.lastWrapper), 197);
      nextNodelet = nextNode?nextNode.getImplNodelet():null;
      selOffset == selNode.length && maskUndefined($getNextSibling_3(filteredHtml, selNode)) === (nextNodelet == null?null:nextNodelet) && !!nextNode && nextNode.isTextNode() && (this$static.lastWrapper = dynamicCast(nextNode, 225));
    }
  }
   finally {
...
function $startTypingSequence_0(this$static, previousSelectionStart){
  ...
  try {
    ...
    cnodeAfter = dynamicCast($getNodeAfter(this$static.contentRange.after), 197);
    ...
    if (instanceOf($e0, 206)) {
      ...
      before = this$static.contentRange.nodeBefore == null?null:dynamicCast(this$static.contentRange.nodeBefore, 197).getImplNodelet();
      after = $getNodeAfter(this$static.contentRange.after) == null?null:dynamicCast($getNodeAfter(this$static.contentRange.after), 197).getImplNodelet();
      this$static.htmlRange = between(before, new Point$El_0(dynamicCast(this$static.contentRange.after.container, 197).getImplNodelet(), after));
    }
     else 
      throw $e0;
  }
...
function $getWordBoundary(this$static, forward_0){
  ...
  forward_0?(s.modify('move', ($clinit_1054() , FORWARD).name_1, ($clinit_1056() , WORD_0).name_1) , undefined):(s.modify('move', ($clinit_1054() , BACKWARD).name_1, ($clinit_1056() , WORD_0).name_1) , undefined);
  try {
    ...
    if (instanceOf($e0, 205)) {
      e = $e0;
      $log_4(($clinit_761() , logger_1).fatalLogger, 'html missing not handled', e);
    }
     else if (instanceOf($e0, 206)) {
      e = $e0;
      $log_4(($clinit_761() , logger_1).fatalLogger, 'html inserted not handled', e);
    }
     else 
      throw $e0;
  }
...
_ = NativeSelectionUtil$NoOpMutationListener.prototype;
_.endTransientMutations = function endTransientMutations_0(){
}
;
_.startTransientMutations = function startTransientMutations_0(){
}
;
function $getBounds(node){
  ...
  if (node.nodeType == 3) {
    parentElement = $getParentElement(node);
    return new IntRange_0($getAbsoluteTop(parentElement), $getAbsoluteTop(parentElement) + (parentElement.offsetHeight || 0));
  }
   else {
    e = node;
    return new IntRange_0($getAbsoluteTop(e), $getAbsoluteTop(e) + (e.offsetHeight || 0));
  }
}
...
function $getFocusPosition(){
  var selection;
  selection = getSelectionGuarded();
  return !selection?null:$getPosition(selection.focusNode, selection.focusOffset);
}

function $getPosition(focusNode, focusOffset){
  var e, ret, txt;
  if (!focusNode || !$getParentElement(focusNode)) {
    return null;
  }
  if (focusNode.nodeType == 3) {
    txt = $doc.createTextNode(focusNode.nodeValue.substr(0, focusOffset - 0));
    try {
      ($clinit_1046() , transientMutationListener).startTransientMutations();
      focusNode.parentNode.insertBefore(txt, focusNode);
      $insertAfter(txt.parentNode, SPAN, txt);
      ret = new OffsetPosition_0(SPAN.offsetLeft || 0, SPAN.offsetTop || 0, SPAN.offsetParent);
      return ret;
    }
     finally {
      $removeFromParent(SPAN);
      $removeFromParent(txt);
      ($clinit_1046() , transientMutationListener).endTransientMutations();
    }
  }
   else {
    e = focusNode;
    return new OffsetPosition_0(e.offsetLeft || 0, e.offsetTop || 0, e.offsetParent);
  }
}

function $isOrdered(){
  var anchorNode, anchorOffset, jsRange, ret, selection;
  jsRange = $getSelectionRange_0();
  if (!jsRange) {
    return true;
  }
  selection = getSelectionGuarded();
  ...
  ret = anchorNode == jsRange.startContainer && anchorOffset == jsRange.startOffset;
  return ret;
}
...
function $clinit_1054(){
  ...
  $VALUES_34 = initValues(_3Lorg_waveprotocol_wave_client_editor_selection_html_SelectionWebkit$Direction_2_classLit, {9:1, 68:1, 170:1}, 111, [FORWARD, BACKWARD, LEFT_2, RIGHT_2]);
}
...
function valueOf_41(name_0){
  $clinit_1054();
  return valueOf_0(($clinit_1055() , $MAP_34), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 111:1};
var $VALUES_34, BACKWARD, FORWARD, LEFT_2, RIGHT_2;
function $clinit_1055(){
  $clinit_1055 = nullMethod;
  $MAP_34 = createValueOfMap(($clinit_1054() , $VALUES_34));
}
...
function $clinit_1056(){
  ...
  $VALUES_35 = initValues(_3Lorg_waveprotocol_wave_client_editor_selection_html_SelectionWebkit$MoveUnit_2_classLit, {9:1, 68:1, 170:1}, 112, [CHARACTER_0, WORD_0, SENTENCE, LINE_1, PARAGRAPH]);
}
...
function valueOf_42(name_0){
  $clinit_1056();
  return valueOf_0(($clinit_1057() , $MAP_35), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 112:1};
var $VALUES_35, CHARACTER_0, LINE_1, PARAGRAPH, SENTENCE, WORD_0;
function $clinit_1057(){
  $clinit_1057 = nullMethod;
  $MAP_35 = createValueOfMap(($clinit_1056() , $VALUES_35));
}
...
function $showSuggestionsNearestTo(this$static, location_0){
  ...
  newCurrent = $findBefore(this$static.suggestables, dynamicCast(location_0.container, 197));
...
function $add_19(this$static, controller){
  $add_31(this$static.updateables, controller);
  return controller;
}
...
function $updateButtonStates(this$static){
  ...
  for (update$iterator = $iterator_20(this$static.updateables); update$iterator.hasNext();) {
    update = dynamicCast(update$iterator.next_0(), 239);
    update.update_0(selectionRange);
  }
}

function ButtonUpdater_0(editor){
  this.updateables = ($clinit_2326() , $clinit_2326() , new CopyOnWriteSet_0(HASH_SET));
  this.editor = editor;
}
...
function $biasFromContainers(this$static, at){
  ...
  return atContainerStart && atContainerEnd?($clinit_1780() , NEITHER):atContainerStart?($clinit_1780() , RIGHT_4):atContainerEnd?($clinit_1780() , LEFT_4):($clinit_1780() , NEITHER);
}
...
function $rebias(this$static, start, end, lastMovement){
  ...
  if (start != end) {
    return $clinit_1780() , RIGHT_4;
  }
  bestPriority = new Box_1(new Double_0(0));
  bias = new Box_1($biasFromContainers(this$static, $locate_0(this$static.doc.doc, start)));
  bias.boxed === ($clinit_1780() , NEITHER)?(bias.boxed = toBiasDirection(lastMovement)):(bestPriority.boxed = new Double_0(5));
  ...
  return dynamicCast(bias.boxed, 137);
}
...
_.apply_1 = function apply_42(key, value){
  ...
  while (behaviours.next) {
    ...
    if (priority > dynamicCast(this.val$bestPriority.boxed, 64).value_0) {
...
function clearAnnotationsOverSelection(editor, keys){
  var range;
  range = $asRange(dynamicCast(checkNotNull_1(editor.getSelectionHelper().getSelectionRange(), 'Editor must have selection'), 209));
...
function formatContentDomString(editor){
  var $e0, selEnd, selStart, seln;
  if (!editor || $isConsistent(editor)) {
    if (editor) {
      seln = $getOrderedHtmlSelection(editor.htmlSelectionHelper);
      try {
        selStart = !seln?null:$nodeletPointToWrapperPoint(editor.nodeManager, seln.first);
        selEnd = !seln?null:$nodeletPointToWrapperPoint(editor.nodeManager, seln.second);
        return $print($select_2(new Pretty_0, selStart, selEnd), editor.content_0.fullContentView);
      }
       catch ($e0) {
        $e0 = caught_0($e0);
        if (!instanceOf($e0, 206))
  ...
  $logPlainText(($clinit_761() , logger_1).errorLogger, 'EditorDocFormatter called with inconsistent Doc');
  return null;
}

function formatImplDomString(editor){
  var editorHtml, selEnd, selStart, selection, view, jsRange;
  if (!editor || $isConsistent(editor)) {
    selection = ($clinit_1046() , jsRange = $getSelectionRange_0() , toOrderedPointRange(jsRange));
    if (selection) {
      editorHtml = editor.element;
      (!$isOrHasChild(editorHtml, dynamicCastJso(selection.first.container)) || $isOrHasChild(editorHtml, dynamicCastJso(selection.second.container))) && (selection = null);
    }
    view = editor.content_0.rawHtmlView;
    selStart = selection?selection.first:null;
    selEnd = selection?selection.second:null;
    return $print($select_2(new Pretty_0, selStart, selEnd), view);
  }
   else {
    $logPlainText(($clinit_761() , logger_1).errorLogger, 'EditorDocFormatter called with inconsistent Doc');
    return null;
...
function $onParticipantRemoved(this$static, participant){
  if (this$static.active) {
    ($clinit_1086() , $shouldLog_0(LOG_3.traceLogger)) && ($logLazyObjects(LOG_3.traceLogger, $expandArgs(this$static.clientInstanceLogLabel, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, ['Participant removed ', participant]))) , undefined);
    $sendCurrentParticipantInformation(this$static);
  }
   else {
    ($clinit_1086() , $shouldLog_0(LOG_3.traceLogger)) && ($logLazyObjects(LOG_3.traceLogger, $expandArgs(this$static.clientInstanceLogLabel, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, ['Participant removed event in deleted node.']))) , undefined);
  }
}
...
function ClientFlagsBase_0(helper){
  ...
  $getBoolean(helper, '5', ($clinit_428() , $clinit_428() , TRUE_0));
  $getInteger(helper, '6', valueOf_13(150));
  $getInteger(helper, '7', valueOf_13(200));
  $getBoolean(helper, '8', FALSE_0);
  $getInteger(helper, '9', valueOf_13(5000));
  this.closeSuggestionsMenuDelayMs = $getInteger(helper, '10', valueOf_13(500));
  ...
  $getInteger(helper, '15', valueOf_13(5000));
  $getBoolean(helper, '16', FALSE_0);
  $getInteger(helper, '17', valueOf_13(20000));
  $getInteger(helper, '18', valueOf_13(20));
  $getInteger(helper, '19', valueOf_13(5));
  ...
  $getInteger(helper, '129', valueOf_13(300000));
  $getBoolean(helper, '130', TRUE_0);
  $getBoolean(helper, '131', TRUE_0);
  $getInteger(helper, '132', valueOf_13(1000));
  ...
  $getInteger(helper, '135', valueOf_13(-1));
  $getInteger(helper, '136', valueOf_13(300));
  ...
  $getInteger(helper, '140', valueOf_13(39));
  dynamicCast($returnDefaultHelper(helper.source.getString('141'), 'static/images/logo.png'), 1);
  $getInteger(helper, '142', valueOf_13(136));
  $getInteger(helper, '143', valueOf_13(3));
  $getInteger(helper, '144', valueOf_13(50));
  $getInteger(helper, '145', valueOf_13(30));
  $getInteger(helper, '146', valueOf_13(10));
  $getInteger(helper, '147', valueOf_13(40));
  $getDouble(helper, '148', new Double_0(0.5));
  $getInteger(helper, '149', valueOf_13(60000));
  $getInteger(helper, '150', valueOf_13(10));
  $getDouble(helper, '151', new Double_0(1));
  $getInteger(helper, '152', valueOf_13(5000));
  ...
  $getInteger(helper, '156', valueOf_13(5));
  $getInteger(helper, '157', valueOf_13(50));
  dynamicCast($returnDefaultHelper(helper.source.getString('158'), 'DISABLED'), 1);
  $getInteger(helper, '159', valueOf_13(1000));
  ...
  $getInteger(helper, '162', valueOf_13(10000));
  $getInteger(helper, '163', valueOf_13(30));
  $getInteger(helper, '164', valueOf_13(10000));
  $getBoolean(helper, '165', FALSE_0);
  $getBoolean(helper, '166', FALSE_0);
  dynamicCast($returnDefaultHelper(helper.source.getString('167'), ''), 1);
  $getInteger(helper, '168', valueOf_13(60000));
  $getBoolean(helper, '169', FALSE_0);
  $getInteger(helper, '170', valueOf_13(300));
  $getInteger(helper, '171', valueOf_13(25));
  $getInteger(helper, '172', valueOf_13(5));
  ...
  $getInteger(helper, '182', valueOf_13(3));
  $getInteger(helper, '183', valueOf_13(100));
  $getInteger(helper, '184', valueOf_13(10));
  $getDouble(helper, '185', new Double_0(0));
  $getDouble(helper, '186', new Double_0(1));
  $getInteger(helper, '187', valueOf_13(100));
  $getInteger(helper, '188', valueOf_13(10000));
  $getInteger(helper, '189', valueOf_13(10000));
  ...
  $getInteger(helper, '215', valueOf_13(60000));
  $getInteger(helper, '216', valueOf_13(15000));
  ...
  $getInteger(helper, '220', valueOf_13(12000));
...
function get_22(){
  ...
  if (!instance_8) {
    jsObj = getJSObj();
    source = jsObj?new WrappedJSObject_0(jsObj):(!singleton_3 && (singleton_3 = new UrlParameters_0($wnd.location.search)) , singleton_3);
...
function $getBoolean(this$static, tag, defaultValue){
  return dynamicCast($returnDefaultHelper(this$static.source.getBoolean(tag), defaultValue), 62);
}

function $getDouble(this$static, tag, defaultValue){
  return dynamicCast($returnDefaultHelper(this$static.source.getDouble(tag), defaultValue), 64);
}

function $getInteger(this$static, tag, defaultValue){
  return dynamicCast($returnDefaultHelper(this$static.source.getInteger(tag), defaultValue), 66);
}
...
_.getBoolean = function getBoolean(key){
  var value;
  return (value = dynamicCast(this.overrides.booleans.get_4(key), 62))?value:null;
}
;
...
_.getDouble = function getDouble(key){
  var value;
  return (value = dynamicCast(this.overrides.doubles.get_4(key), 64))?value:null;
}
;
_.getInteger = function getInteger(key){
  var value;
  return (value = dynamicCast(this.overrides.ints.get_4(key), 66))?value:null;
}
;
...
function $withBoolean(this$static){
  return this$static.booleans.put_3('104', ($clinit_428() , $clinit_428() , TRUE_0)) , this$static;
}

function OverridingTypedSource$MapsHolder_0(){
  this.booleans = ($clinit_2309() , defaultCollectionFactory.createStringMap());
...
_.getBoolean = function getBoolean_0(key){
  var value;
  return (value = dynamicCast(this.booleans.get_4(key), 62))?value:null;
}
;
...
_.getDouble = function getDouble_0(key){
  var value;
  return (value = dynamicCast(this.doubles.get_4(key), 64))?value:null;
}
;
_.getInteger = function getInteger_0(key){
  var value;
  return (value = dynamicCast(this.ints.get_4(key), 66))?value:null;
}
;
...
_.getBoolean = function getBoolean_1(key){
  ...
  return $clinit_428() , $equalsIgnoreCase('true', value)?TRUE_0:FALSE_0;
}
;
...
_.getInteger = function getInteger_1(key){
  ...
  try {
    return valueOf_13(__parseAndValidateInt(value, 10));
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 188)) {
...
_.getBoolean = function getBoolean_2(key){
  return typeof this.jso[key] == 'boolean'?($clinit_428() , this.jso[key]?TRUE_0:FALSE_0):null;
}
;
...
_.getInteger = function getInteger_2(key){
  return typeof this.jso[key] == 'number'?valueOf_13(this.jso[key]):null;
}
;
...
;
function $get_18(this$static, blip){
...
function $upgrade(this$static, edit){
  $add_31(edit.listeners, this$static);
}

_ = DiffController.prototype;
_.onSessionEnd = function onSessionEnd(e, blipUi){
  $stopDiffSuppression(dynamicCast($get_19(this.documents, $blipOf_0(this.models.viewIdMapper, dynamicCast(blipUi.impl, 334).getId())), 275));
}
;
_.onSessionStart = function onSessionStart(e, blipUi){
  $startDiffSuppression(dynamicCast($get_19(this.documents, $blipOf_0(this.models.viewIdMapper, dynamicCast(blipUi.impl, 334).getId())), 275));
}
;
function $clinit_1305(){
  $clinit_1305 = nullMethod;
  ...
  $VALUES_41 = initValues(_3Lorg_waveprotocol_wave_client_wavepanel_impl_edit_Actions$Action_2_classLit, {9:1, 68:1, 170:1}, 118, [EDIT_BLIP, REPLY_TO_BLIP, CONTINUE_THREAD, DELETE_BLIP, DELETE_THREAD]);
}
...
function valueOf_48(name_0){
  $clinit_1305();
  return valueOf_0(($clinit_1306() , $MAP_41), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 118:1};
var $VALUES_41, CONTINUE_THREAD, DELETE_BLIP, DELETE_THREAD, EDIT_BLIP, REPLY_TO_BLIP;
function $clinit_1306(){
  $clinit_1306 = nullMethod;
  $MAP_41 = createValueOfMap(($clinit_1305() , $VALUES_41));
}
...
function $delete(this$static, blipUi){
  ...
  if ($equals_8(blipUi, this$static.focus_0.blip)) {
    parentUi = $asThread($parentOf(dynamicCast(dynamicCast(blipUi.helper, 276), 277).this$0, dynamicCast(blipUi.impl, 278)));
  ...
  $delete_1($blipOf_0(this$static.views.viewIdMapper, dynamicCast(blipUi.impl, 334).getId()));
}
...
function $popupLink(this$static, blipUi){
  ...
  blip = $blipOf_0(this$static.views.viewIdMapper, dynamicCast(blipUi.impl, 334).getId());
  waveId = blip.blip.wavelet.waveId;
  try {
    waveletId = $deserialiseWaveletId($toString_28(dynamicCast(($clinit_2183() , blip.helper.this$0.wavelet.wavelet.id_0), 446)));
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 194)) {
      $wnd.alert('Unable to link to this blip, invalid conversation id ' + $toString_28(dynamicCast(($clinit_2183() , blip.helper.this$0.wavelet.wavelet.id_0), 446)));
      return;
    }
     else 
      throw $e0;
  }
  waveRef = of_13(waveId, waveletId, dynamicCast($get_22(blip.manifestBlip.id_0), 1));
  waveRefStringValue = 'wave://' + ($clinit_2443() , $encode_0(waveRef, ($clinit_2441() , PATH)));
  blipLinkPopupView = new BlipLinkPopupWidget_0(dynamicCast((dynamicCast(blipUi.helper, 276) , blipUi.impl), 278).self_0);
...
function $reply(this$static, blipUi){
  var blip, doc, location_0, reply, document_0, selectionPoints, view, selection, e_1, htmlSelection_1;
  blip = $blipOf_0(this$static.views.viewIdMapper, dynamicCast(blipUi.impl, 334).getId());
  doc = $getDocument_1(dynamicCast($get_18(this$static.documents, blip), 275));
  location_0 = (selectionPoints = (selection = $getSelectionPoints((e_1 = dynamicCast(doc.fullContentView.inner_0.getDocumentElement(), 196).implNodelet , htmlSelection_1 = new HtmlSelectionHelperImpl_0(e_1) , new PassiveSelectionHelper_0(htmlSelection_1, doc.nodeManager, doc.renderedContentView, doc.indexedDoc))) , !selection?null:$asOrderedRange(selection, ($clinit_1046() , $isOrdered()))) , document_0 = doc.mutableContent , view = doc.persistentContentView , getLocationNearSelection_0(document_0, view, selectionPoints));
...
_.onKeySignal = function onKeySignal_3(key){
  var action;
  action = dynamicCast($get_10(this.keyBindings, key), 118);
  return !!action && $doAction(this, action);
}
;
_.castableTypeMap$ = {272:1};
_.actions = null;
_.keyBindings = null;
...
function $endSession(this$static){
  ...
  if (this$static.editing) {
    ...
    $blur_0(this$static.editor);
    $setEditing(this$static.editor, false);
    $removeContent(this$static.editor);
    $reset(this$static.editor);
    $deselect($getMeta_0(this$static.editing), ($clinit_1432() , EDIT));
    $enable_0($getMeta_0(this$static.editing), ($clinit_1493() , DISABLED_WHILE_EDITING_MENU_OPTIONS_SET));
...
function $fireOnSessionEnd(this$static, editor, blipUi){
  ...
  for (listener$iterator = $iterator_20(this$static.listeners); listener$iterator.hasNext();) {
    listener = dynamicCast(listener$iterator.next_0(), 279);
...
function $onKeySignal_2(this$static, signal){
  var key;
  key = ($clinit_607() , getKeyCombo_0(signal.cachedKeyCode, !!signal.nativeEvent.ctrlKey, !!signal.nativeEvent.shiftKey, !!signal.nativeEvent.altKey, !!signal.nativeEvent.metaKey));
  switch (key.ordinal) {
    case 16:
...
function $startEditing(this$static, blipUi){
  ...
  $endSession(this$static);
  document_0 = $getDocument_1(dynamicCast($get_19(this$static.documents, $blipOf_0(this$static.views.viewIdMapper, dynamicCast(blipUi.impl, 334).getId())), 275));
  $disable_0($getMeta(dynamicCast(dynamicCast(blipUi.helper, 276), 277), dynamicCast(blipUi.impl, 278)), ($clinit_1493() , DISABLED_WHILE_EDITING_MENU_OPTIONS_SET));
  $select_1($getMeta(dynamicCast(dynamicCast(blipUi.helper, 276), 277), dynamicCast(blipUi.impl, 278)), ($clinit_1432() , EDIT));
  this$static.editor = ($clinit_769() , e_0 = dynamicCast(document_0.fullContentView.inner_0.getDocumentElement(), 196).implNodelet , checkArgument(!!e_0) , e_0 = $getParentElement(e_0) , checkArgument(!!e_0) , editor_0 = new EditorImpl_0(false, e_0) , $setContent_1(editor_0, document_0) , editor_0);
  $doAdopt(this$static.container, this$static.editor);
  $init_2(this$static.editor, KEY_BINDINGS, EDITOR_SETTINGS);
  $addKeySignalListener(this$static.editor, this$static);
  KEY_BINDINGS.bindings.put(($clinit_633() , ORDER_K), new EditSession$1_0);
  KEY_BINDINGS.bindings.put(ORDER_SHIFT_K, new EditSession$2_0);
  $setEditing(this$static.editor, true);
  $focus_1(this$static.editor, false);
...
;
_.castableTypeMap$ = {204:1, 273:1, 284:1};
_.container = null;
_.documents = null;
_.editing = null;
_.editor = null;
...
_.execute_2 = function execute_54(context){
  !!$getSelectionRange((checkState_2(!!context.passiveSelectionHelper, 'Using the selection helper of an editor not set up.') , $checkContextConsistency(context) , context.passiveSelectionHelper)) && clearAnnotationsOverSelection(context, ($clinit_705() , LINK_KEYS));
}
;
...
function parentOf(blip){
  return blip?$asThread($parentOf(dynamicCast(dynamicCast(blip.helper, 276), 277).this$0, dynamicCast(blip.impl, 278))):null;
}
...
function $init_7(this$static){
  $add_31(this$static.edit.listeners, this$static);
}
...
_.onSessionStart = function onSessionStart_0(editor, blipUi){
  this.viewport = $getThreadContainer(dynamicCast($getContents_0(this.waveUi).impl, 280));
  this.scroller = new DomScrollPanel_0(this.viewport);
  $add_31(editor.updateEvent.updateListeners, this);
}
;
_.onUpdate = function onUpdate_3(event_0){
  var focusEndInScreen, focusInContent, focusInViewport, focusStartInScreen, p, r, viewportEndInScreen, viewportInContent, viewportStartInScreen, selection;
  if (!!this.viewport && event_0.notedSelectionCoordsChanged) {
    r = ($clinit_1046() , selection = getSelectionGuarded() , !selection?null:$getBounds(selection.focusNode, selection.focusOffset));
    if (r) {
      focusStartInScreen = r.first;
      focusEndInScreen = r.second;
      viewportStartInScreen = $getAbsoluteTop(this.viewport) - 0;
      viewportEndInScreen = $bottom(null, this.viewport);
      if (viewportStartInScreen < focusStartInScreen - 50 && focusEndInScreen + 50 < viewportEndInScreen) {
        return;
      }
    }
    p = $getFocusPosition();
    if (!!p && !!p.offsetParent_0) {
      viewportInContent = $getViewport(this.scroller);
      focusInViewport = $top(this.viewport, p.offsetParent_0) + p.top_0;
      focusInContent = focusInViewport + viewportInContent.start;
      if (focusInContent - 50 < viewportInContent.start) {
        this.scroller.element.scrollTop = ~~Math.max(Math.min(focusInContent - 50, 2147483647), -2147483648);
      }
       else if (focusInContent + 50 > viewportInContent.end) {
        this.scroller.element.scrollTop = ~~Math.max(Math.min(focusInContent + 50 - (viewportInContent.end - viewportInContent.start), 2147483647), -2147483648);
      }
       else {
        return;
      }
...
function $handleAddButtonClicked(this$static, context){
  ...
  conversation = $participantsOf_0(this$static.models.viewIdMapper, dynamicCast(participantsUi.impl, 335).getId());
...
function $handleParticipantClicked(this$static, context){
  ...
  participation = $participantOf_0(this$static.models.viewIdMapper, dynamicCast(participantView.impl, 336).getId());
  profile = $getProfile(this$static.profiles, dynamicCast(participation.second, 164));
  profileView = new ProfilePopupWidget_0(dynamicCast((dynamicCast(participantView.helper, 281) , participantView.impl), 282).self_0, ($clinit_1587() , BELOW_RIGHT));
  profileUi = (profileUi_0 = new ProfilePopupPresenter_0(profile, profileView, this$static.profiles) , $init_16(profileUi_0.view, profileUi_0) , profileUi_0);
  $addButton_0(profileUi.view, ($clinit_592() , new SafeHtmlString_0('Remove')), new ParticipantController$3_0(participation, profileView));
...
function $install_6(this$static, handlers){
  $register_0(handlers.clickHandlers, ($clinit_1531() , dynamicCast($get_10(CODES, ($clinit_1453() , ADD_PARTICIPANT)), 1)), new ParticipantController$1_0(this$static));
...
function buildParticipantList(addresses){
  ...
  participants = initDim(_3Lorg_waveprotocol_wave_model_wave_ParticipantId_2_classLit, {9:1, 68:1}, 164, addressList.length, 0);
...
_.onClick = function onClick_6(event_0){
  $removeParticipant(dynamicCast(this.val$participation.first, 249), dynamicCast(this.val$participation.second, 164));
...
function $findMostRecentlyModified(this$static, start){
  ...
  blipUi = start;
  blips = ($clinit_2309() , new HashMap_0);
  while (blipUi) {
    blip = $blipOf_0(this$static.views.viewIdMapper, dynamicCast(blipUi.impl, 334).getId());
    blips.put(valueOf_14(valueOf_14(blip.blip.blip.lastModifiedTime).value_0), blipUi);
    blipUi = $getNext_2(this$static.traverser, blipUi);
  }
  lmt = dynamicCast(($clinit_480() , max_3((entrySet = blips.entrySet_0() , new AbstractMap$1_0(blips, entrySet)))), 67).value_0;
  return dynamicCast(blips.get(valueOf_14(lmt)), 283);
}
...
function ReplyIndicatorController_0(actions, editSession, panel){
  ...
  $add_31(this.editSession.listeners, this);
}
...
_.onMouseDown_0 = function onMouseDown_2(event_0, context){
  ...
  if ($equals_3(($clinit_1531() , dynamicCast($get_10(CODES, ($clinit_1453() , REPLY_BOX)), 1)), context.getAttribute('kind') || '')) {
    indicatorView = $asReplyBox_0(this.panel, context);
    threadView = $asRootThread_0($parentOf(dynamicCast(dynamicCast(indicatorView.helper, 304), 305).this$0, dynamicCast(indicatorView.impl, 306)));
    ...
    threadView = $asInlineThread_0($parentOf(dynamicCast(dynamicCast(indicatorView.helper, 307), 308).this$0, dynamicCast(indicatorView.impl, 309)));
    $addContinuation(this.actions, threadView);
  }
...
_.onSessionEnd = function onSessionEnd_1(e, blipView){
  $asThread($parentOf(dynamicCast(dynamicCast(blipView.helper, 276), 277).this$0, dynamicCast(blipView.impl, 278))).getReplyIndicator().enable_0();
}
;
_.onSessionStart = function onSessionStart_1(e, blipUi){
  var threadUi;
  threadUi = $asThread($parentOf(dynamicCast(dynamicCast(blipUi.helper, 276), 277).this$0, dynamicCast(blipUi.impl, 278)));
  !threadUi.getBlipAfter(blipUi) && threadUi.getReplyIndicator().disable_0();
}
;
_.castableTypeMap$ = {271:1, 279:1};
_.actions = null;
_.editSession = null;
_.panel = null;
...
_.onClick_0 = function onClick_7(event_0, context){
  ...
  switch (dynamicCast(item.impl, 310).getOption().ordinal) {
    case 3:
      dynamicCast(item.impl, 310).isSelected()?$endSession(this.actions.edit):$focusAndEdit(this.actions, $getParent_4($asBlipMeta_0($parentOf(dynamicCast(dynamicCast(item.helper, 311), 312).this$0, dynamicCast(item.impl, 313)))));
      break;
    case 0:
      $reply(this.actions, $getParent_4($asBlipMeta_0($parentOf(dynamicCast(dynamicCast(item.helper, 311), 312).this$0, dynamicCast(item.impl, 313)))));
      break;
    case 1:
      $delete(this.actions, $getParent_4($asBlipMeta_0($parentOf(dynamicCast(dynamicCast(item.helper, 311), 312).this$0, dynamicCast(item.impl, 313)))));
      break;
    case 2:
      $popupLink(this.actions, $getParent_4($asBlipMeta_0($parentOf(dynamicCast(dynamicCast(item.helper, 311), 312).this$0, dynamicCast(item.impl, 313)))));
      break;
...
function $isRead(this$static, blipUi){
  return !$isUnread(this$static.supplement, $blipOf_0(this$static.models.viewIdMapper, dynamicCast(blipUi.impl, 334).getId()));
}
...
function $maybeSetOrUpdateTitle(this$static){
  ...
  if (!!this$static.blipUi && !!this$static.editor) {
    ...
    editBlip = $blipOf_0(this$static.views.viewIdMapper, dynamicCast(this$static.blipUi.impl, 334).getId());
    if (editBlip.parentThread == editBlip.helper.this$0.rootThread && editBlip == $getFirstBlip(editBlip.parentThread) && !($clinit_1755() , start = $firstAnnotationChange_0(document_0, 0, $size_15(document_0.doc), TITLE_KEY, null) , start != -1 && !!$getAnnotation_2(document_0.doc, start, TITLE_KEY).length)) {
...
function $createFontSizeButton(this$static, toolbar_0){
  ...
  submenu.button_0.setShowDropdownArrow(false);
  group = new GroupingToolbar_0(submenu, (fakeButton = $addClickButton_0(submenu) , $setState_0(fakeButton, ($clinit_1644() , INVISIBLE)) , fakeButton));
  for (size$array = initValues(_3Ljava_lang_Integer_2_classLit, {9:1, 68:1}, 66, [valueOf_13(8), valueOf_13(9), valueOf_13(10), valueOf_13(11), valueOf_13(12), valueOf_13(14), valueOf_13(16), valueOf_13(18), valueOf_13(21), valueOf_13(24), valueOf_13(28), valueOf_13(32), valueOf_13(36), valueOf_13(42), valueOf_13(48), valueOf_13(56), valueOf_13(64), valueOf_13(72)]) , size$index = 0 , size$max = size$array.length; size$index < size$max; ++size$index) {
    ...
    b.listener = dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b, this$static.editor, ($clinit_910() , 'style/fontSize'), size / 12 + 'em')), 314);
  }
}
...
function $createHeadingButton(this$static, toolbar_0){
  ...
  group = new GroupingToolbar_0(submenu, (fakeButton = $addClickButton_0(submenu) , $setState_0(fakeButton, ($clinit_1644() , INVISIBLE)) , fakeButton));
  for (level$array = initValues(_3Ljava_lang_Integer_2_classLit, {9:1, 68:1}, 66, [valueOf_13(1), valueOf_13(2), valueOf_13(3), valueOf_13(4)]) , level$index = 0 , level$max = level$array.length; level$index < level$max; ++level$index) {
    ...
    b.listener = $createParagraphApplicationController(this$static, b, ($clinit_925() , checkArgument_2(!$equals_3('li', 'h' + level), "Don't use regularStyle() for list styles, use listStyle()") , new Paragraph$RegularStyler_0('h' + level)));
  }
}

function $createParagraphApplicationController(this$static, b, style){
  return dynamicCast($add_19(this$static.updater, new ParagraphApplicationController_0(b, this$static.editor, style)), 314);
}

function $createTextSelectionController(this$static, b, value){
  return dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b, this$static.editor, ($clinit_910() , 'style/fontFamily'), value)), 314);
}
...
function $enable(this$static, editor){
  ...
  $add_31(editor.updateEvent.updateListeners, this$static.updater);
...
function $init_8(this$static){
  ...
  b = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-MJ-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-bold'), b, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b, this$static.editor, ($clinit_910() , 'style/fontWeight'), 'bold')), 314));
  b_0 = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-FK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-italic'), b_0, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b_0, this$static.editor, 'style/fontStyle', 'italic')), 314));
  b_1 = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-MK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-underline'), b_1, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b_1, this$static.editor, 'style/textDecoration', 'underline')), 314));
  b_2 = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-JK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-strikethrough'), b_2, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b_2, this$static.editor, 'style/textDecoration', 'line-through')), 314));
  group = $addGroup(this$static.toolbarUi);
  b_3 = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-LK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-superscript'), b_3, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b_3, this$static.editor, 'style/verticalAlign', 'super')), 314));
  b_4 = $addToggleButton(group);
  $applyTo_1($setIcon(new ToolbarButtonViewBuilder_0, 'C-KK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-subscript'), b_4, dynamicCast($add_19(this$static.updater, new TextSelectionController_0(b_4, this$static.editor, 'style/verticalAlign', 'sub')), 314));
  group = $addGroup(this$static.toolbarUi);
  ...
  submenu.button_0.setShowDropdownArrow(false);
  $createFontFamilyGroup(this$static, new GroupingToolbar_0(submenu, (fakeButton = $addClickButton_0(submenu) , $setState_0(fakeButton, ($clinit_1644() , INVISIBLE)) , fakeButton)), initValues(_3Lorg_waveprotocol_wave_client_wavepanel_impl_toolbar_EditToolbar$FontFamily_2_classLit, {9:1, 68:1}, 120, [new EditToolbar$FontFamily_0('Default', null)]));
  ...
  $applyTo_0($setIcon(new ToolbarButtonViewBuilder_0, 'C-BK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-EditorToolbarResources-Css-indent'), b_5, new ParagraphTraversalController_0(this$static.editor, ($clinit_925() , INDENTER)));
  ...
  checkState(!!waveRef);
  waveRefToken = encode(($clinit_2443() , $encode_0(waveRef, ($clinit_2441() , QUERY))));
...
function $insertGadget(this$static, url){
  ...
  if (url != null && !!url.length) {
    ...
    if (from != -1) {
      ...
      $clinit_2135();
      appendLine(document_0, xml, ($clinit_1880() , EMPTY_MAP_0));
    }
  }
}
...
function create_37(user, idGenerator, waveId){
  var toolbarUi;
...
_.onClicked = function onClicked_0(){
  clearAnnotationsOverSelection(this.this$0.editor, initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [($clinit_910() , 'style/backgroundColor'), 'style/color', 'style/fontFamily', 'style/fontSize', 'style/fontStyle', 'style/fontWeight', 'style/textDecoration', 'style/verticalAlign']));
...
_.onClicked = function onClicked_1(){
  var popup, selector, chrome, popup_0, titleBar;
  selector = new GadgetSelectorWidget_0(new GadgetInfoProviderImpl_0);
  $addFeaturedOptions(selector);
  popup = (chrome = (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , new DesktopPopupChrome_0) , popup_0 = createPopup_1(null, new CenterPopupPositioner_0, chrome) , titleBar = $getTitleBar(popup_0) , $setTextOrHtml(titleBar.title_0.directionalTextHelper, 'Select Gadget', false) , $add_0(popup_0, selector, popup_0.element) , $show_0(popup_0) , $scheduleDeferred(($clinit_30() , INSTANCE), new GadgetSelectorWidget$1_0(selector)) , $addDomHandler(selector.gadgetFilter, new GadgetSelectorWidget$2_0(selector), ($clinit_149() , $clinit_149() , TYPE_5)) , $addDomHandler(selector.gadgetFilter, new GadgetSelectorWidget$3_0(selector), ($clinit_147() , $clinit_147() , TYPE_4)) , $addDomHandler(selector.gadgetUrl, new GadgetSelectorWidget$4_0(selector), TYPE_4) , $addDomHandler(selector.categoryDropBox, new GadgetSelectorWidget$5_0(selector), ($clinit_113() , $clinit_113() , TYPE_0)) , popup_0);
...
_.onClicked = function onClicked_2(){
  ...
  $init_11(attachmentView, new EditToolbar$3$1_0(this, tmpCursor));
...
function $onDone(this$static, encodedWaveRef, attachmentId, fullFileName){
  ...
  xml = innerXml($parse_1(($clinit_2112() , fileName)));
  ...
  if (this$static.val$cursorLoc != -1) {
    ...
    $clinit_2135();
    appendLine($getDocument(this$static.this$1.this$0.editor), xml, ($clinit_1880() , EMPTY_MAP_0));
  }
...
_.execute_3 = function execute_55(e){
...
function onClearLink(editor){
  !!$getSelectionHelper(editor).getSelectionRange() && clearAnnotationsOverSelection(editor, ($clinit_705() , LINK_KEYS));
}
...
function create_38(focus_0, views, wave, reader){
...
function AttachmentPopupWidget_0(){
  ...
  $addHandler_1(this.form, new AttachmentPopupWidget$1_0, ($clinit_337() , !TYPE_16 && (TYPE_16 = new GwtEvent$Type_0) , $clinit_337() , TYPE_16));
  $addHandler_1(this.form, new AttachmentPopupWidget$2_0(this), (!TYPE_15 && (TYPE_15 = new GwtEvent$Type_0) , TYPE_15));
  $addDomHandler(this.uploadBtn, new AttachmentPopupWidget$3_0(this), ($clinit_116() , $clinit_116() , TYPE_1));
  chrome = (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , new DesktopPopupChrome_0);
  this.popup = createPopup_1(null, new CenterPopupPositioner_0, chrome);
  $add_2(this.popup, this);
  $add_31(this.popup.listeners, this);
}
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 59:1, 349:1};
_.attachmentId = null;
_.fileUpload = null;
_.form = null;
...
function $onSubmitComplete(this$static, event_0){
  ...
  if (results != null && results.indexOf('OK') != -1) {
    ...
    setStyleName_0(this$static.this$0.status_0.element, ($clinit_1351() , 'C-OK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-attachment-AttachmentPopupWidget-Style-done'), true);
    ...
    setStyleName_0(this$static.this$0.status_0.element, ($clinit_1351() , 'C-PK-org-waveprotocol-wave-client-wavepanel-impl-toolbar-attachment-AttachmentPopupWidget-Style-error'), true);
  }
}
...
function $createAndBindUi_0(owner){
  ...
  f_HorizontalPanel3.horzAlign = ($clinit_353() , ALIGN_LEFT);
...
function $clinit_1358(){
  ...
  $VALUES_42 = initValues(_3Lorg_waveprotocol_wave_client_wavepanel_impl_toolbar_gadget_GadgetInfoProvider$GadgetCategoryType_2_classLit, {9:1, 68:1, 170:1}, 121, [ALL, GAME, IMAGE, MAP, MUSIC, PRODUCTIVITY, SEARCH, TEAM, TIME, TRAVEL, UTILITY, VIDEO, VOICE, VOTING, OTHER_0]);
}
...
function of_2(type){
  ...
  for (g$array = $VALUES_42 , g$index = 0 , g$max = g$array.length; g$index < g$max; ++g$index) {
    g = g$array[g$index];
...
function valueOf_49(name_0){
  $clinit_1358();
  return valueOf_0(($clinit_1359() , $MAP_42), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 121:1};
_.type_0 = null;
var $VALUES_42, ALL, GAME, IMAGE, MAP, MUSIC, OTHER_0, PRODUCTIVITY, SEARCH, TEAM, TIME, TRAVEL, UTILITY, VIDEO, VOICE, VOTING;
function $clinit_1359(){
  $clinit_1359 = nullMethod;
  $MAP_42 = createValueOfMap(($clinit_1358() , $VALUES_42));
}
...
function $clinit_1362(){
  $clinit_1362 = nullMethod;
...
function $getGadgetInfoList(this$static, filter, category){
  ...
  for (gadget$iterator = new AbstractList$IteratorImpl_0(this$static.gadgetList); gadget$iterator.i < gadget$iterator.this$0_0.size_1();) {
    gadget = dynamicCast($next_4(gadget$iterator), 315);
    gadgetName = gadget.name_0.toLowerCase();
    gadgetDesc = gadget.description.toLowerCase();
    (gadgetName.indexOf(lowerCaseFilter) != -1 || gadgetDesc.indexOf(lowerCaseFilter) != -1) && ($equals_3(category, ($clinit_1358() , ALL).type_0) || $equals_3(category, gadget.primaryCategory.type_0) || $equals_3(category, gadget.secondaryCategory.type_0)) && (setCheck(filteredList.array, filteredList.size_0++, gadget) , true);
  }
  return filteredList;
}
...
function $startLoadingGadgetList(this$static){
  var $e0, builder, e;
  builder = new RequestBuilder_0(($clinit_185() , GET), '/gadget/gadgetlist');
  try {
    ...
    if (instanceOf($e0, 243)) {
      e = $e0;
      $clinit_1659();
      initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, ['Exception while sending HTTP request: ' + $toString_1(e)]);
    }
     else 
      throw $e0;
  }
...
_.onResponseReceived = function onResponseReceived_0(request, response){
  ...
  if (200 == response.val$xmlHttpRequest.status) {
    ...
    $clinit_1362();
    $clinit_1659();
    initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, ['Server responded with a HTTP error: ' + response.val$xmlHttpRequest.status]);
  }
}
;
_.castableTypeMap$ = {};
...
function GadgetInfoWidget_0(){
  ...
  $initWidget(this, this.self_0 = ($clinit_1370() , domId0 = $createUniqueId($doc) , domId1 = $createUniqueId($doc) , domId2 = $createUniqueId($doc) , domId3 = $createUniqueId($doc) , self_0 = new ImplPanel_0("<div class='C-JW-org-waveprotocol-wave-client-wavepanel-impl-toolbar-gadget-GadgetInfoWidget_BinderImpl_GenCss_style-img'> <img id='" + domId0 + "'> <\/div> <h3 id='" + domId1 + "'><\/h3> <div class='C-IW-org-waveprotocol-wave-client-wavepanel-impl-toolbar-gadget-GadgetInfoWidget_BinderImpl_GenCss_style-description' id='" + domId2 + "'><\/div> <div class='C-IW-org-waveprotocol-wave-client-wavepanel-impl-toolbar-gadget-GadgetInfoWidget_BinderImpl_GenCss_style-description' id='" + domId3 + "'><\/div>") , self_0.element['className'] = 'C-KW-org-waveprotocol-wave-client-wavepanel-impl-toolbar-gadget-GadgetInfoWidget_BinderImpl_GenCss_style-self' , attachRecord0 = attachToDom(self_0.element) , image = $doc.getElementById(domId0) , image.removeAttribute('id') , title = $doc.getElementById(domId1) , title.removeAttribute('id') , description = $doc.getElementById(domId2) , description.removeAttribute('id') , author = $doc.getElementById(domId3) , author.removeAttribute('id') , attachRecord0.origParent?attachRecord0.origParent.insertBefore(attachRecord0.element, attachRecord0.origSibling):orphan(attachRecord0.element) , handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1 = new GadgetInfoWidget_BinderImpl$1_0(this) , $addDomHandler(self_0, handlerMethodWithNameVeryUnlikelyToCollideWithUserFieldNames1, ($clinit_116() , $clinit_116() , TYPE_1)) , this.author = author , this.description = description , this.image = image , this.self_0 = self_0 , this.title_0 = title , $ensureInjected(style_4) , self_0));
  $addDomHandler(this.self_0, new GadgetInfoWidget$1_0(this), ($clinit_155() , $clinit_155() , TYPE_8));
  $addDomHandler(this.self_0, new GadgetInfoWidget$2_0(this), ($clinit_153() , $clinit_153() , TYPE_7));
}
...
;
_.castableTypeMap$ = {5:1, 6:1, 7:1, 8:1, 55:1, 59:1, 316:1};
_.author = null;
_.description = null;
_.gadgetUrl = null;
_.image = null;
...
_.castableTypeMap$ = {24:1, 38:1};
_.val$owner = null;
function $clinit_1370(){
  $clinit_1370 = nullMethod;
...
function $addFeaturedOptions(this$static){
  ...
  $filter(this$static, '');
  for (category$array = ($clinit_1358() , $clinit_1358() , $VALUES_42) , category$index = 0 , category$max = category$array.length; category$index < category$max; ++category$index) {
...
function $filter(this$static, filterText){
  ...
  for (g$iterator = new AbstractList$IteratorImpl_0(gadgetList); g$iterator.i < g$iterator.this$0_0.size_1();) {
    g = dynamicCast($next_4(g$iterator), 315);
  ...
  if (this$static.options.getChildren().size_0 > 0 && !$equals_3(filterText, '')) {
    widget = dynamicCast($get_4(this$static.options.children_0), 316);
...
_.execute_0 = function execute_56(){
  impl_1.focus_1(this.this$0.gadgetFilter.element);
...
_.castableTypeMap$ = {24:1, 38:1};
_.val$owner = null;
function $clinit_1383(){
  $clinit_1383 = nullMethod;
...
function $parseGadgetInfoJson(json){
  ...
  value = ($clinit_233() , parse(json, true));
  array = value.isArray();
  if (array) {
...
_.onParticipantRemoved = function onParticipantRemoved_3(participant){
  ...
  !!participantUi && $remove_35(dynamicCast((dynamicCast(participantUi.helper, 281) , participantUi.impl), 282));
...
function $locateConversation(this$static, modelId){
  return $getConversation(this$static.model, $fromString(($clinit_2183() , dynamicCast(this$static.shortIdToLongIdMap.get_4(modelId), 1))));
}
...
function $locateThread(this$static, modelId){
  ...
  if (parts.length != 2) {
    ...
    c = $getConversation(this$static.model, $fromString(($clinit_2183() , parts[0])));
    return c?dynamicCast(c.threads.get_4(parts[1]), 367):null;
  }
}
...
function $getMenuState(this$static){
  ...
  e = $getFirstChildElement((!this$static.menu && (this$static.menu = load(this$static.id_0, ($clinit_1495() , MENU))) , this$static.menu));
  while (e) {
    if (e.hasAttribute('kind') && $equals_3(e.getAttribute('kind') || '', ($clinit_1531() , dynamicCast($get_10(CODES, ($clinit_1453() , MENU_ITEM)), 1)))) {
...
function $setMenuState(this$static, options, selected){
  var builder, out;
  builder = ($clinit_1493() , new BlipMetaViewBuilder$1_0(options, selected));
  out = new SafeHtmlBuilder_0;
  $outputHtml_1(builder, out);
  (!this$static.menu && (this$static.menu = load(this$static.id_0, ($clinit_1495() , MENU))) , this$static.menu).innerHTML = (new SafeHtmlString_0(out.sb.impl.string)).html || '';
}

_ = BlipMetaDomImpl.prototype;
_.deselect = function deselect(option){
  var item;
  item = dynamicCast($get_10(dynamicCast($getMenuState(this).first, 326), option), 313);
...
_.disable = function disable(toDisable){
  ...
  options = copyOf($keySet_0(dynamicCast(state.first, 326)));
  selected = dynamicCast(state.second, 327);
...
function $asBlipMenuItem(this$static, e){
  return checkArgument(!e || $typeOf(e) == ($clinit_1453() , MENU_ITEM)) , !e?null:new BlipMenuItemViewImpl_0(this$static.menuHelper, new BlipMenuItemDomImpl_0(e, this$static.cssProvider));
}

function $asBlipMeta_0(v){
  checkArgument(!v || v.getType_1() == ($clinit_1453() , META_0));
  return dynamicCast(v, 294);
}

function $asContinuationIndicator(this$static, e){
  checkArgument(!e || $typeOf(e) == ($clinit_1453() , CONTINUATION_INDICATOR));
...
function $asInlineThread_0(v){
  checkArgument(!v || v.getType_1() == ($clinit_1453() , INLINE_THREAD));
  return dynamicCast(v, 293);
}

function $asReplyBox(this$static, e){
  checkArgument(!e || $typeOf(e) == ($clinit_1453() , REPLY_BOX));
...
function $asReplyBox_0(this$static, e){
  return checkArgument(!e || $typeOf(e) == ($clinit_1453() , REPLY_BOX)) , !e?null:new ReplyBoxViewImpl_0(this$static.rootThreadIndicatorHelper, new ReplyBoxDomImpl_0(e, e.id));
}

function $asRootThread_0(v){
  checkArgument(!v || v.getType_1() == ($clinit_1453() , ROOT_THREAD));
  return dynamicCast(v, 296);
}

function $fromAddButton(this$static, e){
  checkArgument(!e || $typeOf(e) == ($clinit_1453() , ADD_PARTICIPANT));
  while (!!e && !(e.hasAttribute('kind') && KNOWN_KINDS.contains_0(e.getAttribute('kind') || ''))) {
    e = $getParentElement(e);
  }
  return checkArgument(!e || $typeOf(e) == ($clinit_1453() , PARTICIPANTS)) , !e?null:new ParticipantsViewImpl_0(this$static.participantsHelper, new ParticipantsDomImpl_0(e, e.id));
}
...
function $setToolbar_0(impl, e){
  $setToolbar(dynamicCast(impl, 280), e);
}
...
function $getToolbarContainer(this$static){
  !this$static.toolbarContainer && (this$static.toolbarContainer = $doc.getElementById($getDomId_5(($clinit_1527() , TOOLBAR_CONTAINER), this$static.id_0)));
  return this$static.toolbarContainer;
}

function $clinit_1491(){
  $clinit_1491 = nullMethod;
  $clinit_103();
  $push_1(toInject, ($clinit_211() , '.C-HL-org-waveprotocol-wave-client-wavepanel-view-dom-full-BlipLinkPopupWidget-Style-self {\n  margin : 0 2px 0 2px;\n  line-height : 1.5;\n  overflow : hidden;\n}\n.C-IL-org-waveprotocol-wave-client-wavepanel-view-dom-full-BlipLinkPopupWidget-Style-title {\n  font-size : 15px;\n  whitespace : nowrap;\n  color : #5a99df;\n}\n.C-FL-org-waveprotocol-wave-client-wavepanel-view-dom-full-BlipLinkPopupWidget-Style-explanation {\n  font-size : 10px;\n  color : gray;\n}\n.C-GL-org-waveprotocol-wave-client-wavepanel-view-dom-full-BlipLinkPopupWidget-Style-link {\n  font-size : 14px;\n  color : black;\n  overflow : hidden;\n  width : 32em;\n}\n'));
  flush();
}

function BlipLinkPopupWidget_0(relative){
  ...
  chrome = (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , new DesktopPopupChrome_0);
  this.popup = createPopup_1(relative, ($clinit_1587() , ABOVE_RIGHT), chrome);
  $add_2(this.popup, this);
  $add_31(this.popup.listeners, this);
}
...
function getMenuOption(id){
  $clinit_1493();
  var option;
  option = dynamicCast(MENU_OPTIONS.get_4(id), 122);
  if (!option) {
...
function $flush_3(this$static){
  if (!this$static.toPageIn.isEmpty()) {
    while ($pageIn_0(this$static.pager, dynamicCast(this$static.toPageIn.remove_5(), 247)) , !this$static.toPageIn.isEmpty()) {
    }
...
_.getOption = function getOption_0(){
  return dynamicCast(this.impl, 310).getOption();
}
;
_.isSelected = function isSelected_0(){
  return dynamicCast(this.impl, 310).isSelected();
}
;
function $deselect(this$static, option){
  dynamicCast(this$static.impl, 339).deselect(option);
}

function $disable_0(this$static, options){
  dynamicCast(this$static.impl, 339).disable(options);
}

function $enable_0(this$static, options){
  dynamicCast(this$static.impl, 339).enable(options);
}

function $getParent_4(this$static){
  return $asBlip_0($parentOf(dynamicCast(dynamicCast(this$static.helper, 286), 301).this$0, dynamicCast(this$static.impl, 302)));
}

function $select_1(this$static, option){
  dynamicCast(this$static.impl, 339).select(option);
}

_ = BlipMetaViewImpl.prototype;
_.deselect = function deselect_1(option){
  dynamicCast(this.impl, 339).deselect(option);
}
;
_.disable = function disable_5(options){
  dynamicCast(this.impl, 339).disable(options);
}
;
_.enable = function enable_6(options){
  dynamicCast(this.impl, 339).enable(options);
}
;
_.select = function select_2(option){
  dynamicCast(this.impl, 339).select(option);
}
;
_ = ContinuationIndicatorViewImpl.prototype;
_.disable_0 = function disable_6(){
  dynamicCast(this.impl, 340).disable_0();
}
;
_.enable_0 = function enable_7(){
  dynamicCast(this.impl, 340).enable_0();
}
;
_ = ThreadViewImpl.prototype;
_.getId = function getId_17(){
  return dynamicCast(this.impl, 344).getId();
}
;
_ = InlineThreadViewImpl.prototype;
_.getReplyIndicator = function getReplyIndicator(){
  return $asContinuationIndicator(dynamicCast(dynamicCast(this.helper, 323), 341).this$0, $getNextSiblingElement($getFirstChildElement($getChrome(dynamicCast(this.impl, 332).c))));
}
;
_ = ParticipantViewImpl.prototype;
_.getId = function getId_18(){
  return dynamicCast(this.impl, 336).getId();
}
;
_ = ParticipantsViewImpl.prototype;
_.getId = function getId_19(){
  return dynamicCast(this.impl, 335).getId();
}
;
_ = ReplyBoxViewImpl.prototype;
_.disable_0 = function disable_7(){
  dynamicCast(this.impl, 343).disable_0();
}
;
_.enable_0 = function enable_8(){
  dynamicCast(this.impl, 343).enable_0();
}
;
_ = RootThreadViewImpl.prototype;
_.getReplyIndicator = function getReplyIndicator_0(){
  return $asReplyBox(dynamicCast(dynamicCast(this.helper, 345), 346).this$0, $getNextSiblingElement($getFirstChildElement(dynamicCast(this.impl, 331).self_0)));
}
;
function $setToolbar_1(this$static, toolbar_0){
  $setToolbar_0((dynamicCast(this$static.helper, 347) , this$static.impl), toolbar_0);
}
...
function $updateState(this$static){
  ...
  for (lastOnTop = numChildren - 1; lastOnTop >= 0; --lastOnTop) {
    if (!(dynamicCast($get_7(this$static.panel.items, lastOnTop), 350).proxy.proxy.state != ($clinit_1644() , INVISIBLE))) {
      continue;
    }
    if (!((dynamicCast($get_7(this$static.panel.items, lastOnTop), 350).onToplevel.element.offsetTop || 0) > 0)) {
      break;
    }
    itemHasOverflowed = true;
  }
  itemHasOverflowed && $setState_0(this$static.panel.overflowSubmenu, ($clinit_1644() , DISABLED_0));
...
function $updateStateEventually(this$static){
  (!instance_7 && (instance_7 = new BrowserBackedScheduler_0 , setDefaultTimerService() , undefined) , instance_7.taskInfos.get(this$static.stateUpdater) != null) || (!instance_7 && (instance_7 = new BrowserBackedScheduler_0 , setDefaultTimerService() , undefined) , $schedule_2(instance_7, ($clinit_1200() , LOW), this$static.stateUpdater));
}
...
_.castableTypeMap$ = {252:1, 253:1};
_.this$0 = null;
function CenterPopupPositioner_0(){
}

function CenterPopupPositioner(){
}

_ = CenterPopupPositioner_0.prototype = CenterPopupPositioner.prototype = new Object_0;
_.getClass$ = function getClass_1038(){
  return Lorg_waveprotocol_wave_client_widget_popup_CenterPopupPositioner_2_classLit;
}
;
_.setPopupPositionAndMakeVisible = function setPopupPositionAndMakeVisible_2(relative, p){
  $clinit_1197();
  $schedule_2(scheduler_0, ($clinit_1200() , LOW), new CenterPopupPositioner$1_0(p));
}
;
_.castableTypeMap$ = {};
function CenterPopupPositioner$1_0(val$p){
  this.val$p = val$p;
}

function CenterPopupPositioner$1(){
}

_ = CenterPopupPositioner$1_0.prototype = CenterPopupPositioner$1.prototype = new Object_0;
_.execute_0 = function execute_59(){
  var height, top_0;
  this.val$p.style['left'] = ~~((($clinit_386() , parseInt(get_0().element['offsetWidth']) || 0) - (this.val$p.offsetWidth || 0)) / 2) + ($clinit_88() , 'px');
  height = min_1(this.val$p.offsetHeight || 0, $getClientHeight($doc) - 32);
  top_0 = ~~(((parseInt(get_0().element['offsetHeight']) || 0) - height) / 2);
  this.val$p.style['top'] = (top_0 > 0?top_0:0) + 'px';
  this.val$p.style['height'] = height + 'px';
  this.val$p.style['visibility'] = ($clinit_99() , 'visible');
}
;
_.getClass$ = function getClass_1039(){
  return Lorg_waveprotocol_wave_client_widget_popup_CenterPopupPositioner$1_2_classLit;
}
;
_.castableTypeMap$ = {252:1, 253:1};
_.val$p = null;
...
function $getTitleBar(this$static){
  if (!this$static.titleBar) {
    ...
    $insert_1(this$static, this$static.titleBar, 0);
    !!this$static.chrome && (setStyleName_0(this$static.chrome.frame.element, 'C-HT-org-waveprotocol-wave-client-widget-popup-desktopchrome-DesktopPopupChrome-Resources-Css-titled', true) , undefined);
  }
  return this$static.titleBar;
}

_ = DesktopUniversalPopup.prototype;
_.clear = function clear_25(){
  $clear_2(this);
  !!this.chrome && ($add_0(this, this.chrome, this.element) , undefined);
}
;
...
function $onShow_0(this$static){
  $add_31(this$static.events.listeners, this$static);
}
...
_.getClass$ = function getClass_1046(){
...
function $init_16(this$static, listener){
  checkState(!this$static.listener);
  checkArgument(!!listener);
  this$static.listener = listener;
}
...
function ProfilePopupWidget_0(relative, positioner){
  ...
  chrome = (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , new DesktopPopupChrome_0);
  this.popup = (!provider_1 && (provider_1 = new DesktopPopupProvider_0) , new DesktopUniversalPopup_0(relative, positioner, chrome, true));
  $add_2(this.popup, this);
  $add_31(this.popup.listeners, this);
}
...
_.getClass$ = function getClass_1047(){
...
_.getClass$ = function getClass_1048(){
...
;
_.getClass$ = function getClass_1049(){
...
_.parent_0 = null;
_.state = null;
function $clinit_1628(){
  $clinit_1628 = nullMethod;
  $clinit_103();
  $push_1(toInject, ($clinit_211() , '.C-LU-org-waveprotocol-wave-client-widget-toolbar-SubmenuToolbarWidget-Css-toolbar {\n  background-color : white;\n}\n'));
  flush();
}
...
function $insertAbstractButton(this$static, button, beforeIndex){
  ...
  $setState_0(this$static, ($clinit_1644() , ENABLED));
}
...
function $onChildStateChanged(this$static, item, newState){
  if (newState == ($clinit_1644() , ENABLED)) {
...
_.getClass$ = function getClass_1050(){
...
function $moveToOverflowBucket(this$static, index){
  var item;
  item = dynamicCast($get_7(this$static.items, index), 350);
  item.asAbstractButton.parent_0 = this$static.overflowSubmenu;
  $setDelegate_0(item.proxy, item.onOverflow);
  $setState_1(item.onToplevel, ($clinit_1644() , INVISIBLE));
...
function $onBeginOverflowLayout(this$static){
  ...
  for (item$iterator = new AbstractList$IteratorImpl_0(this$static.items); item$iterator.i < item$iterator.this$0_0.size_1();) {
    item = dynamicCast($next_4(item$iterator), 350);
    item.asAbstractButton.parent_0 = this$static;
    $setDelegate_0(item.proxy, item.onToplevel);
    $setState_3(item.onOverflow, ($clinit_1644() , INVISIBLE));
  }
  $setState_0(this$static.overflowSubmenu, ($clinit_1644() , INVISIBLE));
}
...
_.indexOf_0 = function indexOf_0(button){
  ...
  for (i = 0; i < this.items.size_0; ++i) {
    if (dynamicCast($get_7(this.items, i), 350).asAbstractButton == button) {
      return i;
    }
  }
...
;
_.getClass$ = function getClass_1054(){
...
_.getClass$ = function getClass_1055(){
...
_.getClass$ = function getClass_1056(){
...
function $clinit_1639(){
  $clinit_1639 = nullMethod;
...
;
_.getClass$ = function getClass_1057(){
...
_.setDown = function setDown_0(isDown){
  this.isDown = ($clinit_428() , isDown?TRUE_0:FALSE_0);
...
_.isDown = null;
_.listener = null;
function $clinit_1644(){
  $clinit_1644 = nullMethod;
  ...
  $VALUES_54 = initValues(_3Lorg_waveprotocol_wave_client_widget_toolbar_buttons_ToolbarButtonView$State_2_classLit, {9:1, 68:1, 170:1}, 133, [ENABLED, DISABLED_0, INVISIBLE]);
}
...
function valueOf_61(name_0){
  $clinit_1644();
  return valueOf_0(($clinit_1645() , $MAP_54), name_0);
}
...
_.getClass$ = function getClass_1058(){
  return Lorg_waveprotocol_wave_client_widget_toolbar_buttons_ToolbarButtonView$State_2_classLit;
}
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 133:1};
var $VALUES_54, DISABLED_0, ENABLED, INVISIBLE;
function $clinit_1645(){
  $clinit_1645 = nullMethod;
  $MAP_54 = createValueOfMap(($clinit_1644() , $VALUES_54));
}
...
function $setShowDivider_0(this$static, showDivider){
  this$static.showDivider = ($clinit_428() , showDivider?TRUE_0:FALSE_0);
...
function $setShowDropdownArrow_0(this$static, showDropdownArrow){
  this$static.showDropdownArrow = ($clinit_428() , showDropdownArrow?TRUE_0:FALSE_0);
...
function ToolbarButtonViewProxy_0(){
  this.dcs = ($clinit_2309() , defaultCollectionFactory.createStringSet());
}
...
;
_.getClass$ = function getClass_1059(){
...
_.setShowDivider = function setShowDivider_2(showDivider){
  this.showDivider = ($clinit_428() , showDivider?TRUE_0:FALSE_0);
...
_.setShowDropdownArrow = function setShowDropdownArrow_2(showDropdownArrow){
  this.showDropdownArrow = ($clinit_428() , showDropdownArrow?TRUE_0:FALSE_0);
...
;
_.getClass$ = function getClass_1060(){
...
_.getClass$ = function getClass_1062(){
...
_.onHide = function onHide_5(source){
  ...
  $remove_42(this.activePopup.listeners, this);
...
_.onToggledOn = function onToggledOn_1(){
  this.activePopup = createPopup_1(this.toggleButton.button_0.hackGetWidget().element, ($clinit_1587() , BELOW_RIGHT), (!provider_0 && (provider_0 = new DesktopPopupChromeProvider_0) , new DesktopPopupChrome_0));
  $associateWidget_1(this.activePopup, this.toggleButton.button_0.hackGetWidget());
  $add_31(this.activePopup.listeners, this);
...
_.getClass$ = function getClass_1063(){
...
;
_.getClass$ = function getClass_1064(){
...
_.getClass$ = function getClass_1065(){
...
_.getClass$ = function getClass_1066(){
...
;
_.castableTypeMap$ = {30:1, 38:1};
function $clinit_1658(){
  $clinit_1658 = nullMethod;
...
function $logPlainText_0(this$static, msg, t){
  this$static.this$0.handleClientErrors(this$static.level, t, initValues(_3Ljava_lang_Object_2_classLit, {9:1, 68:1}, 0, [msg]));
...
_.compareTo$ = function compareTo_11(other){
  return $compareTo_10(this, dynamicCast(other, 352));
}
;
...
_.getClass$ = function getClass_1073(){
...
function $clinit_1755(){
  var op;
  $clinit_1755 = nullMethod;
  var b;
  TITLE_KEY = join(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['title']));
  b = new DocInitializationBuilder_0;
  $clinit_1716();
  $elementStart_2(b, 'body', ($clinit_1880() , EMPTY_MAP_0));
  $annotationBoundary_0(b, $build_5($initializationValues(($clinit_2020() , new AnnotationBoundaryMapImpl$Builder_0), initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [TITLE_KEY, '']))));
  $elementStart_2(b, 'line', EMPTY_MAP_0);
  $add_9(b.accu, ($clinit_2053() , INSTANCE_16));
  $add_9(b.accu, INSTANCE_16);
  $annotationBoundary_0(b, $build_5($initializationEnd(new AnnotationBoundaryMapImpl$Builder_0, initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [TITLE_KEY]))));
  asInitialization((op = new BufferedDocOpImpl_0(dynamicCast($toArray_1(b.accu, ($clinit_2032() , EMPTY_ARRAY_0)), 228)) , checkWellformedness(op) , op));
}
...
function findImplicitTitle(doc){
  ...
  outer: for (node$iterator = ($clinit_2098() , $iterator_17(iterate(doc, ($clinit_1716() , getElementWithTagName(doc, ($clinit_2135() , checkState_2(topLevelContainerTagname != null, 'Top level line container tag name not set!') , $clinit_2135() , topLevelContainerTagname))), null, FORWARD_DEPTH_FIRST_ITERATOR))); node$iterator.next != null;) {
...
function $delete_1(this$static){
  ...
  allReplies = ($clinit_2309() , defaultCollectionFactory.createQueue());
  ...
  for (replyThread$iterator = allReplies.iterator_0(); replyThread$iterator.hasNext();) {
    replyThread = dynamicCast(replyThread$iterator.next_0(), 367);
...
function $deleteThread_0(this$static, threadToDelete){
  ...
  $clearInlineReplyAnchors(this$static, ($clinit_2309() , $clinit_480() , new Collections$UnmodifiableSet_0(newHashSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [threadToDelete == threadToDelete.helper.this$0.rootThread?'':dynamicCast($get_22(threadToDelete.manifestThread.id_0), 1)])))));
}
...
function $deleteThreads(this$static){
  ...
  for (threadToDelete$iterator = new AbstractList$IteratorImpl_0(threads); threadToDelete$iterator.i < threadToDelete$iterator.this$0_0.size_1();) {
    threadToDelete = dynamicCast($next_4(threadToDelete$iterator), 367);
    $deleteBlips(threadToDelete);
    $removeReply(this$static.manifestBlip, threadToDelete.manifestThread);
  }
...
_.exec_0 = function exec_0(doc){
  ...
  elementsToDelete = ($clinit_2309() , new ArrayList_0);
  for (el$iterator = ($clinit_2098() , $iterator_17(iterate(doc, doc.doc.substrate.getDocumentElement(), null, FORWARD_DEPTH_FIRST_ELEMENT_ITERATOR))); el$iterator.next != null;) {
...
;
_.getClass$ = function getClass_1119(){
...
;
_.getClass$ = function getClass_1120(){
...
function $deleteBlip_0(this$static, blipToDelete, shouldDeleteSelfIfEmpty){
  checkArgument_2(this$static.blips.containsKey_1(dynamicCast($get_22(blipToDelete.manifestBlip.id_0), 1)), "Can't delete blip not from this thread");
  $deleteThreads(blipToDelete);
  $removeBlip(this$static.manifestThread, blipToDelete.manifestBlip);
  blipToDelete.blip.blip.content_0.getMutableDocument().size_1() != 0 && blipToDelete.blip.blip.content_0.getMutableDocument().emptyElement(dynamicCast(blipToDelete.blip.blip.content_0.getMutableDocument().getDocumentElement(), 260));
...
function $deleteBlips(this$static){
  ...
  for (replyBlip$iterator = new AbstractList$IteratorImpl_0(valueList(this$static.blips)); replyBlip$iterator.i < replyBlip$iterator.this$0_0.size_1();) {
    replyBlip = dynamicCast($next_4(replyBlip$iterator), 373);
...
function $getFirstBlip(this$static){
  ...
  if (!this$static.blips.isEmpty()) {
    manifestBlip = dynamicCast($get_7(this$static.manifestThread.blips.orderedValues, 0), 369);
    result = dynamicCast(this$static.blips.get_4(dynamicCast($get_22(manifestBlip.id_0), 1)), 373);
    if (!result) {
      for (firstBlip$iterator = $iterator_13((manifestBlips = this$static.manifestThread.blips.orderedValues , new WaveletBasedConversationThread$1_0(this$static, manifestBlips))); firstBlip$iterator.next != null;) {
        firstBlip = dynamicCast((result_0 = firstBlip$iterator.next , $advance(firstBlip$iterator) , result_0), 373);
        result = firstBlip;
        break;
      }
    }
...
function $clinit_1784(){
  $clinit_1784 = nullMethod;
  ...
  $VALUES_60 = initValues(_3Lorg_waveprotocol_wave_model_document_AnnotationBehaviour$CursorDirection_2_classLit, {9:1, 68:1, 170:1}, 139, [FROM_LEFT, FROM_RIGHT, NEUTRAL_0]);
}
...
function valueOf_67(name_0){
  $clinit_1784();
  return valueOf_0(($clinit_1785() , $MAP_60), name_0);
}
...
_.getClass$ = function getClass_1129(){
  return Lorg_waveprotocol_wave_model_document_AnnotationBehaviour$CursorDirection_2_classLit;
}
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 139:1};
var $VALUES_60, FROM_LEFT, FROM_RIGHT, NEUTRAL_0;
function $clinit_1785(){
  $clinit_1785 = nullMethod;
  $MAP_60 = createValueOfMap(($clinit_1784() , $VALUES_60));
}
...
_.getClass$ = function getClass_1166(){
...
function $next_16(this$static){
  ...
  rawRange = dynamicCast(this$static.val$iterator.next_0(), 181);
  key = rawRange.key;
...
_.getClass$ = function getClass_1167(){
...
function decompose(op){
  ...
  op.apply_8(target);
  return new Pair_0(dynamicCast($finish_2(target.insertionOp), 207), dynamicCast($finish_2(target.noninsertionOp), 207));
}
...
_.finish_0 = function finish_6(){
  return new Pair_0(dynamicCast($finish_2(this.insertionOp), 207), dynamicCast($finish_2(this.noninsertionOp), 207));
}
;
...
_.updateAttributes = function updateAttributes_19(attrUpdate){
  ...
  for (i = 0; i < attrUpdate.updates.size_1(); ++i) {
    update = $composeWith(update, new AttributesUpdateImpl_1(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [dynamicCast(attrUpdate.updates.get_0(i), 384).name_0, dynamicCast(attrUpdate.updates.get_0(i), 384).newValue, dynamicCast(attrUpdate.updates.get_0(i), 384).oldValue])));
  }
...
function $transformOperations(insertionOp, noninsertionOp){
  ...
  insertionOp = dynamicCast(insertionTarget.targetDocument.finish_0(), 207);
  noninsertionOp = dynamicCast(noninsertionTarget.targetDocument.finish_0(), 207);
...
_.finish_0 = function finish_8(){
  return dynamicCast(this.targetDocument.finish_0(), 207);
}
;
...
_.otherTarget = null;
_.relativePosition = null;
function $clinit_1964(){
  $clinit_1964 = nullMethod;
...
function $transformOperations_1(this$static, clientOp, serverOp){
  ...
  try {
    ...
    clientOp = dynamicCast($finish_2(clientTarget.targetDocument), 207);
    serverOp = dynamicCast($finish_2(serverTarget.targetDocument), 207);
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 411)) {
      e = $e0;
...
_.getClass$ = function getClass_1258(){
...
_.getClass$ = function getClass_1259(){
...
function $commenceDeletion(this$static){
  ...
  for (entry$iterator = otherTracker.propagating.entrySet_0().iterator_0(); entry$iterator.hasNext();) {
    ...
    update = dynamicCast(entry.getValue(), 407);
    forCombining = dynamicCast(this$static.active.get(key), 407);
    ...
    if (update) {
      ...
      forCombining?$add_9(changeOldValues, forCombining.oldValue):otherTracker.active.containsKey(key)?$add_9(changeOldValues, dynamicCast(otherTracker.active.get(key), 407).newValue):$add_9(changeOldValues, update.oldValue);
    }
     else if (otherTracker.active.containsKey(key)) {
      currentActive = dynamicCast(otherTracker.active.get(key), 407);
      setCheck(changeKeys.array, changeKeys.size_0++, key);
  ...
  $commit(this$static, new AnnotationBoundaryMapImpl_0(initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0), dynamicCast($toArray_1(changeKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(changeOldValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(changeNewValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408)));
}
...
function $commit(this$static, map){
  ...
  for (i = 0; i < map.endKeys.length; ++i) {
    key = map.endKeys[i];
    this$static.propagating.containsKey(key) || this$static.propagating.put(key, dynamicCast(this$static.active.get(key), 407));
    this$static.active.remove_3(key);
  }
  for (i = 0; i < map.changeKeys.length; ++i) {
    key = map.changeKeys[i];
    oldActive = dynamicCast(this$static.active.get(key), 407);
...
_.getClass$ = function getClass_1260(){
...
_.getClass$ = function getClass_1261(){
...
_.process = function process_0(map){
  ...
  for (i = 0; i < map.endSize(); ++i) {
    ...
    serverValues = dynamicCast(this.this$0.serverAnnotationTracker.tracked.get(key), 407);
  ...
  $commit(this, new AnnotationBoundaryMapImpl_0(dynamicCast($toArray_1(clientEndKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeOldValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeNewValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408)));
  $commit(this.this$0.serverAnnotationTracker, new AnnotationBoundaryMapImpl_0(dynamicCast($toArray_1(serverEndKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeOldValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeNewValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408)));
}
;
_.castableTypeMap$ = {};
_.this$0 = null;
...
_.getClass$ = function getClass_1262(){
...
_.process = function process_1(map){
  ...
  for (i = 0; i < map.endSize(); ++i) {
    key = map.getEndKey_0(i);
    clientValues = dynamicCast(this.this$0.clientAnnotationTracker.tracked.get(key), 407);
    if (clientValues) {
      setCheck(clientChangeKeys.array, clientChangeKeys.size_0++, key);
  ...
  $commit(this, new AnnotationBoundaryMapImpl_0(dynamicCast($toArray_1(serverEndKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeOldValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(serverChangeNewValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408)));
  $commit(this.this$0.clientAnnotationTracker, new AnnotationBoundaryMapImpl_0(dynamicCast($toArray_1(clientEndKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeKeys, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeOldValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408), dynamicCast($toArray_1(clientChangeNewValues, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, 0, 0)), 408)));
}
;
_.castableTypeMap$ = {};
_.this$0 = null;
...
_.getClass$ = function getClass_1263(){
...
_.getClass$ = function getClass_1264(){
...
_.getClass$ = function getClass_1265(){
...
_.getClass$ = function getClass_1267(){
...
_.deleteElementEnd = function deleteElementEnd_21(){
  $resolveRange_0(this, 1, ($clinit_1964() , deleteElementEndResolver)) == 0 && (this.rangeCache = new NoninsertionTransformer$Target$DeleteElementEndCache_0(this));
}
;
...
_.finish_0 = function finish_10(){
  return dynamicCast($finish_2(this.targetDocument), 207);
}
;
_.getClass$ = function getClass_1268(){
...
_.retain = function retain_19(itemCount){
  $resolveRange_0(this, itemCount, ($clinit_1964() , retainResolver));
  this.rangeCache = this.retainCache;
}
;
...
_.getClass$ = function getClass_1269(){
...
_.getClass$ = function getClass_1270(){
...
_.getClass$ = function getClass_1271(){
...
_.getClass$ = function getClass_1272(){
...
_.resolveUpdateAttributes = function resolveUpdateAttributes_1(update){
  $doDeleteElementStart_0(this.this$1, this.type_0, dynamicCast($updateWith(this.attributes, update, true), 410));
  ++this.this$1.depth;
}
;
_.castableTypeMap$ = {};
...
_.getClass$ = function getClass_1273(){
...
_.resolveUpdateAttributes = function resolveUpdateAttributes_2(update){
  $syncAnnotations(this.this$1);
  $replaceAttributes_0(this.this$1.targetDocument, dynamicCast($updateWith(this.oldAttributes, update, true), 410), this.newAttributes);
  $retain_0(this.this$1.otherTarget.targetDocument, 1);
}
;
_.castableTypeMap$ = {};
...
_.getClass$ = function getClass_1274(){
...
_.resolveDeleteElementStart = function resolveDeleteElementStart_3(type, attributes){
  $doDeleteElementStart_0(this.this$1.otherTarget, type, dynamicCast($updateWith(attributes, this.update, true), 410));
  ++this.this$1.otherTarget.depth;
}
;
_.resolveReplaceAttributes = function resolveReplaceAttributes_3(oldAttributes, newAttributes){
  $syncAnnotations(this.this$1);
  $retain_0(this.this$1.targetDocument, 1);
  $replaceAttributes_0(this.this$1.otherTarget.targetDocument, dynamicCast($updateWith(oldAttributes, this.update, true), 410), newAttributes);
}
;
...
_.resolveUpdateAttributes = function resolveUpdateAttributes_3(update){
  ...
  for (i = 0; i < update.updates.size_1(); ++i) {
    updated.put(dynamicCast(update.updates.get_0(i), 384).name_0, dynamicCast(update.updates.get_0(i), 384).newValue);
  }
  newUpdate = new AttributesUpdateImpl_0;
  for (i = 0; i < this.update.updates.size_1(); ++i) {
    key = dynamicCast(this.update.updates.get_0(i), 384).name_0;
    newOldValue = updated.containsKey(key)?dynamicCast(updated.get(key), 1):dynamicCast(this.update.updates.get_0(i), 384).oldValue;
    newUpdate = $composeWith(newUpdate, new AttributesUpdateImpl_1(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, [key, newOldValue, dynamicCast(this.update.updates.get_0(i), 384).newValue])));
  }
  $updateAttributes_0(this.this$1.targetDocument, newUpdate);
  keySet = new HashSet_0;
  for (i = 0; i < this.update.updates.size_1(); ++i) {
    $add_13(keySet, dynamicCast(this.update.updates.get_0(i), 384).name_0);
  }
...
_.getClass$ = function getClass_1275(){
...
_.getClass$ = function getClass_1276(){
...
;
_.getClass$ = function getClass_1277(){
...
;
_.getClass$ = function getClass_1278(){
...
function transform(clientOp, serverOp){
  ...
  try {
    ...
    ci0 = dynamicCast(c.first, 207);
    cn0 = dynamicCast(c.second, 207);
    si0 = dynamicCast(s.first, 207);
    sn0 = dynamicCast(s.second, 207);
...
function $initializationValues(this$static, pairs){
  ...
  keys = initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ~~(pairs.length / 2), 0);
  values = initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ~~(pairs.length / 2), 0);
  for (i = 0; i < keys.length; ++i) {
    keys[i] = pairs[i * 2];
    values[i] = pairs[i * 2 + 1];
  }
  this$static.changeKeys = keys;
  this$static.changeOldValues = initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, keys.length, 0);
...
function nearestCommonAncestor_0(doc, node1, node2){
  ...
  ancestors = ($clinit_2309() , defaultCollectionFactory.createIdentityMap());
...
function transparentSlice(splitAt, cxt){
  ...
  if ($getNodeAfter(pPoint) != null) {
    ...
    return maskUndefined(cxt.this$0.fullContentView.inner_0.getParentElement(nodeAfter)) !== maskUndefined(pPoint.container)?new Point$El_0(pPoint.container, $transparentSlice(cxt.this$0.fullContentView, dynamicCast(nodeAfter, 197))):pPoint;
  }
   else {
    return pPoint;
  }
...
function $next_28(this$static){
  ...
  entry = dynamicCast($remove_11(this$static.entries), 440);
  !this$static.rangedAnnotation?(this$static.rangedAnnotation = new RangedAnnotationImpl_0(entry.key, entry.value_0, entry.start, entry.end)):$set_10(this$static.rangedAnnotation, entry.key, entry.value_0, entry.start, entry.end);
...
_.compareTo$ = function compareTo_15(other){
  return this.start - dynamicCast(other, 440).start;
}
;
_.getClass$ = function getClass_1391(){
...
function getRelatedLineElement(doc, at){
  $clinit_2135();
  var atStart;
  atStart = roundLocation(doc, ($clinit_2138() , LINE_2), at, ($clinit_2136() , LEFT_5));
...
function isAtLineEnd(doc, point){
  $clinit_2135();
  return (checkNotNull_1(point, 'getLocation: Null point') , doc.doc.getLocation_0(point)) == $getLocation_0(doc, roundLocation(doc, ($clinit_2138() , LINE_2), point, ($clinit_2136() , RIGHT_5)));
}
...
function roundLocation(doc, rounding, location_0, direction){
  ...
  switch (rounding.ordinal) {
    ...
    case 3:
      ...
      if (direction == ($clinit_2136() , RIGHT_5)) {
...
function $clinit_2136(){
  $clinit_2136 = nullMethod;
  LEFT_5 = new LineContainers$RoundDirection_0('LEFT', 0);
  RIGHT_5 = new LineContainers$RoundDirection_0('RIGHT', 1);
  $VALUES_72 = initValues(_3Lorg_waveprotocol_wave_model_document_util_LineContainers$RoundDirection_2_classLit, {9:1, 68:1, 170:1}, 157, [LEFT_5, RIGHT_5]);
}
...
function valueOf_79(name_0){
  $clinit_2136();
  return valueOf_0(($clinit_2137() , $MAP_72), name_0);
}
...
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 157:1};
var $VALUES_72, LEFT_5, RIGHT_5;
function $clinit_2137(){
  $clinit_2137 = nullMethod;
  $MAP_72 = createValueOfMap(($clinit_2136() , $VALUES_72));
}

var $MAP_72;
function $clinit_2138(){
  $clinit_2138 = nullMethod;
  NONE_6 = new LineContainers$Rounding_0('NONE', 0);
  ...
  $VALUES_73 = initValues(_3Lorg_waveprotocol_wave_model_document_util_LineContainers$Rounding_2_classLit, {9:1, 68:1, 170:1}, 158, [NONE_6, WORD_1, SENTENCE_0, LINE_2]);
}
...
function valueOf_80(name_0){
  $clinit_2138();
  return valueOf_0(($clinit_2139() , $MAP_73), name_0);
}
...
_.getClass$ = function getClass_1393(){
  return Lorg_waveprotocol_wave_model_document_util_LineContainers$Rounding_2_classLit;
}
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 158:1};
var $VALUES_73, LINE_2, NONE_6, SENTENCE_0, WORD_1;
function $clinit_2139(){
  $clinit_2139 = nullMethod;
  $MAP_73 = createValueOfMap(($clinit_2138() , $VALUES_73));
}
...
function $select_2(this$static, selStart, selEnd){
  this$static.selStartEl = selStart?selStart.asElementPoint():null;
  this$static.selStartTx = selStart?selStart.asTextPoint():null;
  this$static.selEndEl = selEnd?selEnd.asElementPoint():null;
  this$static.selEndTx = selEnd?selEnd.asTextPoint():null;
  this$static.collapsed = !!selStart && $equals_11(selStart, selEnd);
  return this$static;
}
...
function $set_10(this$static, key, value, start, end){
  checkPositionIndexesInRange(start, end, 2147483647);
...
function RangedAnnotationImpl_0(key, value, start, end){
  $set_10(this, key, value, start, end);
}
...
_.getClass$ = function getClass_1405(){
...
;
_.castableTypeMap$ = {181:1};
_.end = 0;
_.key = null;
_.start = 0;
_.value_0 = null;
function $clinit_2156(){
  $clinit_2156 = nullMethod;
...
_.apply_15 = function apply_133(c){
  return $clinit_2156() , null != String.fromCharCode(c).match(/[A-Z\d]/i) || c == 95;
}
;
_.getClass$ = function getClass_1407(){
...
_.apply_15 = function apply_135(c){
  return $clinit_2156() , ' \t'.indexOf(fromCodePoint(c)) != -1;
}
;
_.getClass$ = function getClass_1409(){
...
;
_.getClass$ = function getClass_1410(){
...
_.getClass$ = function getClass_1411(){
...
function $wrap_1(this$static, tagName, attribs){
  ...
  return $wrap_3(this$static, tagName, dynamicCast($toArray_1(attribList, initDim(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, attribs.backend.size_1() * 2, 0)), 408));
}

function createFromXmlStringWithContraints(xmlContent, permittedChars){
  return innerXml_0($parse_1(($clinit_2112() , xmlContent)), permittedChars);
}
...
;
_.getClass$ = function getClass_1413(){
...
function constructXml(url, author){
  var builder;
  builder = new XmlStringBuilderDoc_0(null, ($clinit_2011() , ANY));
  $wrap_3(builder, 'gadget', initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['url', url, 'title', '', 'prefs', '', 'state', '', 'author', author]));
  return builder;
}
...
_.equals$ = function equals_64(obj){
  var other;
  if (!(obj != null && obj.castableTypeMap$ && !!obj.castableTypeMap$[450])) {
    return false;
  }
  other = dynamicCast(obj, 450);
  return $equals_18(this.participant, other.participant);
}
;
_.getClass$ = function getClass_1437(){
...
;
_.castableTypeMap$ = {450:1, 466:1};
_.participant = null;
function $clinit_2217(){
  $clinit_2217 = nullMethod;
  defaultAnnotations = ($clinit_2309() , defaultCollectionFactory.createStringMap());
  defaultAnnotations.put_3('style/textDecoration', newStringSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['none'])));
  defaultAnnotations.put_3('style/fontWeight', newStringSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['normal'])));
  defaultAnnotations.put_3('style/fontStyle', newStringSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['normal'])));
  defaultAnnotations.put_3('style/backgroundColor', newStringSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['initial', 'transparent'])));
  defaultAnnotations.put_3('style/color', newStringSet(initValues(_3Ljava_lang_String_2_classLit, {9:1, 68:1, 408:1}, 1, ['black'])));
}
...
function $endAnnotation_2(this$static, builder, annotationKey){
  ...
  annotationStack = dynamicCast(this$static.startedAnnotations.get(annotationKey), 454);
  ...
  if (annotationStack.arrayList.size_0 == 0 && current != null) {
    defaultAnnotations.containsKey_1(annotationKey) && dynamicCast(defaultAnnotations.get_4(annotationKey), 455).contains_0(current) || $add_9(builder.mutationList, new Nindo$EndAnnotation_0(annotationKey));
    ...
    (current == null?nextAnnotation != null:!$equals_3(current, nextAnnotation)) && (defaultAnnotations.containsKey_1(annotationKey) && dynamicCast(defaultAnnotations.get_4(annotationKey), 455).contains_0(nextAnnotation)?$add_9(builder.mutationList, new Nindo$EndAnnotation_0(annotationKey)):$add_9(builder.mutationList, new Nindo$StartAnnotation_0(annotationKey, nextAnnotation)));
  }
}
  ...
  switch (currentType.ordinal) {
    case 6:
      if ($getCurrentToken(tokenizer).data_0 != null) {
        $characters(builder, $coerceString(($clinit_2011() , $getCurrentToken(tokenizer).data_0)));
    ...
    case 1:
    case 3:
      this$static.structureStack.size_0 > 0 && (this$static.indentationLevel -= dynamicCast($remove_12(this$static.structureStack, this$static.structureStack.size_0 - 1), 161).indent);
      break;
...
function $peek_3(this$static){
  ...
  return dynamicCast($get_7(this$static.structureStack, this$static.structureStack.size_0 - 1), 161);
}
...
function $startAnnotation_2(this$static, builder, annotationKey, annotationValue){
  ...
  if (annotationValue == null?current != null:!$equals_3(annotationValue, current)) {
    if (current == null && defaultAnnotations.containsKey_1(annotationKey) && dynamicCast(defaultAnnotations.get_4(annotationKey), 455).contains_0(annotationValue))
    ;
    else {
...
function $structuralAttributes(this$static, tokenizer){
  ...
  if (currentStructureType) {
    ...
    if ($getCurrentToken(tokenizer).type_0 == ($clinit_2219() , LIST_ITEM)) {
...
function RichTextMutationBuilder_0(defaultValueMap){
  ...
  this.affectedKeys = ($clinit_2309() , defaultCollectionFactory.createStringSet());
...
_.getClass$ = function getClass_1443(){
...
function $clinit_2219(){
  $clinit_2219 = nullMethod;
  UNORDERED_LIST_START = new RichTextTokenizer$Type_1('UNORDERED_LIST_START', 0, ($clinit_2221() , BLOCK_RANGE), 1);
...
function valueOf_82(name_0){
  $clinit_2219();
  return valueOf_0(($clinit_2220() , $MAP_75), name_0);
}
...
_.getClass$ = function getClass_1444(){
  return Lorg_waveprotocol_wave_model_richtext_RichTextTokenizer$Type_2_classLit;
}
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 161:1};
_.group = null;
_.indent = 0;
var $VALUES_75, LINK_END, LINK_START, LIST_ITEM, NEW_LINE, ORDERED_LIST_END, ORDERED_LIST_START, STYLE_BG_COLOR_END, STYLE_BG_COLOR_START, STYLE_COLOR_END, STYLE_COLOR_START, STYLE_FONT_FAMILY_END, STYLE_FONT_FAMILY_START, STYLE_FONT_STYLE_END, STYLE_FONT_STYLE_START, STYLE_FONT_WEIGHT_END, STYLE_FONT_WEIGHT_START, STYLE_TEXT_DECORATION_END, STYLE_TEXT_DECORATION_START, TEXT_1, UNORDERED_LIST_END, UNORDERED_LIST_START;
function $clinit_2220(){
  $clinit_2220 = nullMethod;
  $MAP_75 = createValueOfMap(($clinit_2219() , $VALUES_75));
}

var $MAP_75;
function $clinit_2221(){
  $clinit_2221 = nullMethod;
  ...
  $VALUES_76 = initValues(_3Lorg_waveprotocol_wave_model_richtext_RichTextTokenizer$Type$TypeGroup_2_classLit, {9:1, 68:1, 170:1}, 160, [BLOCK_RANGE, BLOCK_1, TEXTUAL, STYLE]);
}
...
function valueOf_83(name_0){
  $clinit_2221();
  return valueOf_0(($clinit_2222() , $MAP_76), name_0);
}
...
_.getClass$ = function getClass_1445(){
  return Lorg_waveprotocol_wave_model_richtext_RichTextTokenizer$Type$TypeGroup_2_classLit;
}
;
_.castableTypeMap$ = {9:1, 10:1, 65:1, 160:1};
var $VALUES_76, BLOCK_1, BLOCK_RANGE, STYLE, TEXTUAL;
function $clinit_2222(){
  $clinit_2222 = nullMethod;
  $MAP_76 = createValueOfMap(($clinit_2221() , $VALUES_76));
}

var $MAP_76;
function $clinit_2223(){
  $clinit_2223 = nullMethod;
  fontWeightMap = ($clinit_2309() , defaultCollectionFactory.createStringMap());
  ...
  FONT_WEIGHT_HANDLER = new RichTextTokenizerImpl$StyleTokenExtractor_0(($clinit_2219() , STYLE_FONT_WEIGHT_START), STYLE_FONT_WEIGHT_END, fontWeightMap, 'fontWeight');
...
function $addTextToken(this$static, text){
  ...
  for (i = 0; i < text.length; ++i) {
    ...
    if (ch == 160) {
      ...
      builder.impl.string.length != 0 && $addToken(this$static, new RichTextTokenizerImpl$Token_1(($clinit_2219() , TEXT_1), builder.impl.string));
      $addToken(this$static, new RichTextTokenizerImpl$Token_0(($clinit_2219() , NEW_LINE)));
...
function $addToken(this$static, token){
  token.type_0.group != ($clinit_2221() , STYLE) && (this$static.mergeNextNewLine = token.type_0.group == BLOCK_1);
  $add_9(this$static.tokenList, token);
}

function $addTokenOrIncrement(this$static, replace, token, endType){
  (replace || this$static.activeTokenCounts[endType.ordinal] <= 0) && (token.type_0.group != ($clinit_2221() , STYLE) && (this$static.mergeNextNewLine = token.type_0.group == BLOCK_1) , $add_9(this$static.tokenList, token));
...
function $getCurrentToken(this$static){
  ...
  return dynamicCast($get_7(this$static.tokenList, this$static.tokenIndex), 456);
}
...
function $handleLinkElement(this$static, el, tagName){
  ...
  if ($equalsIgnoreCase('a', tagName)) {
    ...
    if (attr != null) {
      $addTokenOrIncrement(this$static, false, new RichTextTokenizerImpl$Token_1(($clinit_2219() , LINK_START), attr), LINK_END);
      return LINK_END;
    }
  }
  return null;
...
function $handleListElement(this$static, tagName){
  if ($equalsIgnoreCase('ol', tagName)) {
    $addTokenOrIncrement(this$static, true, new RichTextTokenizerImpl$Token_0(($clinit_2219() , ORDERED_LIST_START)), ORDERED_LIST_END);
    return ORDERED_LIST_END;
  }
   else if ($equalsIgnoreCase('ul', tagName)) {
    $addTokenOrIncrement(this$static, true, new RichTextTokenizerImpl$Token_0(($clinit_2219() , UNORDERED_LIST_START)), UNORDERED_LIST_END);
...
function $handleStyleElements(this$static, el, tagName, closeStack){
  ...
  if (value_0 = el.style['color'] , value_0 != null && !!value_0.length) {
    ...
    $addTokenOrIncrement(this$static, true, new RichTextTokenizerImpl$Token_1(($clinit_2219() , STYLE_COLOR_START), value), STYLE_COLOR_END);
  ...
  if (value_1 = el.style['backgroundColor'] , value_1 != null && !!value_1.length) {
    ...
    $addTokenOrIncrement(this$static, true, new RichTextTokenizerImpl$Token_1(($clinit_2219() , STYLE_BG_COLOR_START), value), STYLE_BG_COLOR_END);
    $add_9(closeStack, STYLE_BG_COLOR_END);
  }
  if (value_2 = el.style['fontFamily'] , value_2 != null && !!value_2.length) {
    value = el.style['fontFamily'];
    $addTokenOrIncrement(this$static, true, new RichTextTokenizerImpl$Token_1(($clinit_2219() , STYLE_FONT_FAMILY_START), value), STYLE_FONT_FAMILY_END);
...
function $processElement(this$static, element){
  ...
  if ($equalsIgnoreCase('p', tagName) || $equalsIgnoreCase('div', tagName) || $equalsIgnoreCase('li', tagName)) {
    if ($equalsIgnoreCase('li', tagName)) {
      $addToken(this$static, new RichTextTokenizerImpl$Token_0(($clinit_2219() , LIST_ITEM)));
    }
     else {
    ...
    $addToken(this$static, new RichTextTokenizerImpl$Token_1(($clinit_2219() , NEW_LINE), tagName));
    maybeEndParagraph = true;
    setEndBlockPending = true;
  }
    ...
    if ($equalsIgnoreCase('table', tagName)) {
      ...
      ($equalsIgnoreCase('th', tagName) || $equalsIgnoreCase('td', tagName)) && $addToken(this$static, new RichTextTokenizerImpl$Token_1(($clinit_2219() , TEXT_1), ' '));
  }
   else {
  ...
  while (closingTypeStack.size_0 != 0) {
    closingType = dynamicCast($remove_12(closingTypeStack, closingTypeStack.size_0 - 1), 161);
...
function RichTextTokenizerImpl_0(doc){
  ...
  this.activeTokenCounts = initDim(_3I_classLit, {9:1}, -1, ($clinit_2219() , $clinit_2219() , $VALUES_75).length, 1);
...
_.getClass$ = function getClass_1446(){
...
_.getClass$ = function getClass_1447(){
...
_.getClass$ = function getClass_1448(){
...
function $checkpoint_0(this$static){
  if (this$static.lastPartition > 0) {
    $push_2(this$static.partitions, valueOf_13(this$static.lastPartition));
...
function $releaseCheckpoint(this$static){
  ...
  return dynamicCast($pop(this$static.partitions), 66).value_0;
}
...
function $pop_0(this$static){
  ...
  entry = dynamicCast($pop(this$static.stack_0), 467);
  op = invert(dynamicCast(entry.op, 207));
  ...
  nextEntry = this$static.stack_0.arrayList.size_0 == 0?null:dynamicCast($peek_1(this$static.stack_0), 467);
...
_ = IntPair.prototype = new Object_0;
_.getClass$ = function getClass_1525(){
  return Lorg_waveprotocol_wave_model_util_IntPair_2_classLit;
}
;
_.castableTypeMap$ = {};
_.first = 0;
_.second = 0;
function IntRange_0(start, end){
  this.first = start;
  this.second = end;
  checkArgument_2(start <= end, 'Start of range must be <= end');
}

function IntRange(){
}

_ = IntRange_0.prototype = IntRange.prototype = new IntPair;
_.getClass$ = function getClass_1526(){
  return Lorg_waveprotocol_wave_model_util_IntRange_2_classLit;
}
;
_.castableTypeMap$ = {};
...
function $removeParticipant_1(this$static, participant){
  ($clinit_480() , new Collections$UnmodifiableSet_0(this$static.wavelet.participants)).contains(participant) && $authoriseApplyAndSend(this$static, new RemoveParticipant_0($createContext(this$static.contextFactory), participant));
}
